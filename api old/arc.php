...
<div style="border:0px solid blue">
    ...
    <div style="border-left:1px solid blue; float:right; width:98.3%" id="right_content">
        ...
        <div style="padding:5px;">
            ...
            <input type="text" id="action" class="hover" value="v2.ikase.org/api" style="width:81.5%; border-bottom:1px solid blue; border-left:0px; border-right:0px; border-top:0px; outline: none;; font-size:1.3em" />
