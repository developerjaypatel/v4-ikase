 ...
 */
	...
	$from_address="donotreplay@ikase.org";
 ...
 */
	...
	$subject="Matrix HTML and attach - " . date("m/d H:i:s");;
	...
	$to_name="Nick Gmail";
	$to_address="nick,gizpenc@gmail.com";
	$email_message->SetEncodedEmailHeader("To",$to_address,$to_name);
 ...
 */
	...
	$image_attachment=array(
		"FileName"=>"https://v2.ikase.org/uploads/1033/Jellyfish.jpg",
		"Content-Type"=>"automatic/name",
		"Disposition"=>"attachment"
	);
