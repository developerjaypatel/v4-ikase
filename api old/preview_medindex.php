...
if ($extension == "pdf") {
	$iframe = '<iframe id="medindex_frame" src="https://v2.ikase.org/uploads/' . $_SESSION["user_customer_id"] . "/" . $case_id . "/" . $folder . "/" . $destination . '".' . $extension . '" width="100%" height="800px"></iframe>';
	echo $iframe;
