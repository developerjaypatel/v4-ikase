...
if (isset($_SERVER['DOCUMENT_ROOT']) && $_SERVER['DOCUMENT_ROOT'] == "C:\\inetpub\\wwwroot\\ikase.org") {
	...
	*/
	...
	if ($_SESSION['user_customer_id']=='1049') {
		$blnGlauber2 = false;
		$strpos = strpos($_SESSION['user_id'], '2');
		if ($strpos !== false && substr($_SESSION['user_id'], $strpos, strlen($_SESSION['user_id']) - $strpos) == '2') {
			$blnGlauber2 = true;
		}
		// || $_SESSION['user_plain_id']==383 || $blnGlauber2
		if ($_SESSION['user_plain_id']==34) {
			//die("<div style='color:white;background:black'>GLAUBER TESTING IS TURNED OFF UNTIL OPTIMIZATION IS COMPLETED</div>");
			$dbname = "ikase_glauber2";
		}
	}
}
...
<html lang="en">
  ...
  <body>
   ...
   <?php 
	...
	<script type="text/javascript" src="lib/jquery.uploadifive.min.js"></script>
	...
	<script type="text/javascript" src="lib/zipLookup.min.js"></script>
	<script type="text/javascript" src="lib/backbone.autocomplete.js"></script>
	<script type="text/javascript" src="lib/backbone.autocomplete_attorney.js"></script>
	<script type="text/javascript" src="lib/backbone.autocomplete_kase.js"></script>
	<script type="text/javascript" src="lib/backbone.autocomplete_worker.js"></script>
	<script type="text/javascript" src="lib/backbone.autocomplete_reps.js"></script>
	<script type="text/javascript" src="lib/backbone.autocomplete_specialty.js"></script>
	<script async type="text/javascript" src="lib/jquery.ui.touch-punch.js"></script>
    <script async type="text/javascript" src="lib/jquery.tokeninput.js"></script>
	...
	<script async type="text/javascript" src="lib/offline.min.js"></script>-->
    ...
    <script async type="text/javascript" src="lib/tripledes.js"></script>
	<script async type="text/javascript" src="lib/localforage.js"></script>
    
    <script async type="text/javascript" src="lib/jquery.jspanel.js"></script>
	...
	<script type="text/javascript" src="js/models/accidentmodel.js"></script>
	<script type="text/javascript" src="js/models/activitymodel.js"></script>
	<script type="text/javascript" src="js/models/applicantmodel.js"></script>
    <script type="text/javascript" src="js/models/attorney_search_model.js"></script>    
    <script type="text/javascript" src="js/models/bodypartsmodel.js"></script>    
	<script type="text/javascript" src="js/models/calendarmodel.js"></script>
	<script type="text/javascript" src="js/models/chatsmodel.js"></script>
    <script type="text/javascript" src="js/models/checkmodel.js"></script>
	<script type="text/javascript" src="js/models/corporationmodel.js"></script>
    <script type="text/javascript" src="js/models/customersettingmodel.js"></script>
	<script type="text/javascript" src="js/models/documentmodel.js"></script>
	<script type="text/javascript" src="js/models/documentsearchmodel.js"></script>
	<script type="text/javascript" src="js/models/employeemodel.js"></script>
	<script type="text/javascript" src="js/models/emailmodel.js"></script>
    <script type="text/javascript" src="js/models/eams_carriers_model.js"></script>
    <script type="text/javascript" src="js/models/eams_formmodel.js"></script>
	<script type="text/javascript" src="js/models/eams_reps_model.js"></script>
    <script type="text/javascript" src="js/models/eventmodel.js"></script>
	<script type="text/javascript" src="js/models/exammodel.js"></script>
    <script type="text/javascript" src="js/models/feemodel.js"></script>
	<script type="text/javascript" src="js/models/home_medicalmodel.js"></script>
	<script type="text/javascript" src="js/models/injurymodel.js"></script>
    <script type="text/javascript" src="js/models/injurynumbermodel.js"></script>
	<script type="text/javascript" src="js/models/kasemodel.js"></script>
    <script type="text/javascript" src="js/models/lienmodel.js"></script>
    <script type="text/javascript" src="js/models/messagesmodel.js"></script>
	<script type="text/javascript" src="js/models/formsmodel.js"></script>
    <script type="text/javascript" src="js/models/newnotemodel.js"></script>
	<script type="text/javascript" src="js/models/notemodel.js"></script>
	<script type="text/javascript" src="js/models/partiemodel.js"></script>
    <script type="text/javascript" src="js/models/personmodel.js"></script>
    <script type="text/javascript" src="js/models/rolodexmodel.js"></script>
    <script type="text/javascript" src="js/models/remindermodel.js"></script>
	<script type="text/javascript" src="js/models/scrapemodel.js"></script>
	<script type="text/javascript" src="js/models/settlementmodel.js"></script>
    <script type="text/javascript" src="js/models/signaturemodel.js"></script>
    <script type="text/javascript" src="js/models/specialty_model.js"></script>	<!-- ??? -->
    <script type="text/javascript" src="js/models/specialtiesmodel.js"></script>
	<script type="text/javascript" src="js/models/tasksmodel.js"></script>
	<script type="text/javascript" src="js/models/usermodel.js"></script>
    <script type="text/javascript" src="js/models/usersettingmodel.js"></script>
    <script type="text/javascript" src="js/models/vservicesmodel.js"></script>
    <script type="text/javascript" src="js/models/webmailmodel.js"></script>
    <script type="text/javascript" src="js/models/worker_search_model.js"></script>
    <?php 
		if ($blnDebug) {
			$time = microtime();
			$time = explode(' ', $time);
    ...
    -->
	<script type="text/javascript" src="js/views/person_details.js"></script>
	<script type="text/javascript" src="js/views/parties_details.js"></script>
	<script type="text/javascript" src="js/setting_module.js"></script>
			
	<script type="text/javascript" src="js/views/activity_listing.js"></script>
	<script type="text/javascript" src="js/views/archive_listing.js"></script>
	<script type="text/javascript" src="js/views/applicant_details.js"></script>
			
	<script type="text/javascript" src="js/views/calendar_details.js"></script>
	<script type="text/javascript" src="js/views/calendar_listing.js"></script>
	<script type="text/javascript" src="js/views/check_details.js"></script>
			
	<script type="text/javascript" src="js/views/costs_details.js"></script>
	<script type="text/javascript" src="js/views/eams_forms_view.js"></script>
	<script type="text/javascript" src="js/views/eams_scrape.js"></script>
			
	<script type="text/javascript" src="js/views/event_listing.js"></script>
	<script type="text/javascript" src="js/views/exam_details.js"></script>
	<script type="text/javascript" src="js/views/fee_details.js"></script>
	<script type="text/javascript" src="js/views/kase_nav_bar.js"></script>
	<script type="text/javascript" src="js/views/kase_nav_left.js"></script>
	<script type="text/javascript" src="js/views/kase_list_category.js"></script>
	<script type="text/javascript" src="js/views/kase_home.js"></script>
			
	<script type="text/javascript" src="js/views/kase_listing.js"></script>
	<script type="text/javascript" src="js/views/partie_listing.js"></script>
	<script type="text/javascript" src="js/views/kase_event_list.js"></script>
	<script type="text/javascript" src="js/views/kase_details.js"></script>
	<script type="text/javascript" src="js/views/kase_occurences.js"></script>
	<script type="text/javascript" src="js/views/kase_control_panel.js"></script>
			
	<script type="text/javascript" src="js/views/bodyparts_details.js"></script>
	<script type="text/javascript" src="js/views/chat_details.js"></script>
	<script type="text/javascript" src="js/views/customer_setting_listing.js"></script>
	<script type="text/javascript" src="js/views/dashboard_view.js"></script>
	<script type="text/javascript" src="js/views/dashboard_home_view.js"></script>
	<script type="text/javascript" src="js/views/dashboard_injury_view.js"></script>
	<script type="text/javascript" src="js/views/dashboard_person_view.js"></script>
	<script type="text/javascript" src="js/views/dashboard_settlement_view.js"></script>
	<script type="text/javascript" src="js/views/dashboard_user_view.js"></script>
	<script type="text/javascript" src="js/views/dialog_details.js"></script>
	<script type="text/javascript" src="js/views/document_details.js"></script>
	<script type="text/javascript" src="js/views/document_import.js"></script>
	<script type="text/javascript" src="js/views/document_search.js"></script>
	<script type="text/javascript" src="js/views/document_upload.js"></script>
	<script type="text/javascript" src="js/views/eams_forms_view.js"></script>
	<script type="text/javascript" src="js/views/eams_form_attach.js"></script>
	<script type="text/javascript" src="js/views/event_details.js"></script>
	<script type="text/javascript" src="js/views/forms_listing.js"></script>
	<script type="text/javascript" src="js/views/kai_details.js"></script>
	<script type="text/javascript" src="js/views/lien_details.js"></script>
	<script type="text/javascript" src="js/views/message_attach.js"></script>
	<script type="text/javascript" src="js/views/messages_details.js"></script>
	<script type="text/javascript" src="js/views/message_listing.js"></script>
	<script type="text/javascript" src="js/views/new_note_details.js"></script>
	<script type="text/javascript" src="js/views/email_details.js"></script>
	<script type="text/javascript" src="js/views/home_medical_view.js"></script>
	<script type="text/javascript" src="js/views/injury_details.js"></script>
	<script type="text/javascript" src="js/views/injury_number_details.js"></script>
	<script type="text/javascript" src="js/views/interoffice_details.js"></script>
	<script type="text/javascript" src="js/views/letter_attach.js"></script>
	<script type="text/javascript" src="js/views/letters_details.js"></script>
	<script type="text/javascript" src="js/views/kase_list_task.js"></script>
	<script type="text/javascript" src="js/views/partie_cards.js"></script>
	<script type="text/javascript" src="js/views/notes_details.js"></script>
	<script type="text/javascript" src="js/views/rolodex_details.js"></script>
	<script type="text/javascript" src="js/views/setting_attach.js"></script>
	<script type="text/javascript" src="js/views/settlement_details.js"></script>
	<script type="text/javascript" src="js/views/signature_details.js"></script>
	<script type="text/javascript" src="js/views/stacks_details.js"></script>
	<script type="text/javascript" src="js/views/task_listing.js"></script>
	<script type="text/javascript" src="js/views/tasks_details.js"></script>
	<script type="text/javascript" src="js/views/template_listing.js"></script>
	<script type="text/javascript" src="js/views/template_upload.js"></script>
	<script type="text/javascript" src="js/views/user_details.js"></script>
	<script type="text/javascript" src="js/views/user_setting_listing.js"></script>
	<script type="text/javascript" src="js/views/webmail_listing.js"></script>
    
	<script type="text/javascript" src="js/views/accident_details.js"></script>
	<script type="text/javascript" src="js/views/activity_listing.js"></script>
    <script type="text/javascript" src="js/views/archive_listing.js"></script>
	<script type="text/javascript" src="js/views/applicant_details.js"></script>
	<script type="text/javascript" src="js/views/calendar_details.js"></script>
    ...
    <script type="text/javascript" src="js/views/bodyparts_details.js"></script>
	<script type="text/javascript" src="js/views/rental_details.js"></script>    
	<script type="text/javascript" src="js/views/chat_details.js"></script>
	<script type="text/javascript" src="js/views/customer_setting_listing.js"></script>
	<script type="text/javascript" src="js/views/dashboard_view.js"></script>
	<script type="text/javascript" src="js/views/dashboard_accident_view.js"></script>
    <script type="text/javascript" src="js/views/dashboard_home_view.js"></script>
	<script type="text/javascript" src="js/views/dashboard_injury_view.js"></script>
    <script type="text/javascript" src="js/views/dashboard_person_view.js"></script>
    <script type="text/javascript" src="js/views/dashboard_settlement_view.js"></script>
	...
	<script type="text/javascript" src="js/views/kai_details.js"></script>
    <script type="text/javascript" src="js/views/lien_details.js"></script>
	<script type="text/javascript" src="js/views/medical_specialties_select.js"></script>
	<script type="text/javascript" src="js/views/message_attach.js"></script>
	<script type="text/javascript" src="js/views/messages_details.js"></script>
    <script type="text/javascript" src="js/views/message_listing.js"></script>
	<script type="text/javascript" src="js/views/multichat_view.js"></script>
	<script type="text/javascript" src="js/views/parties_details.js"></script>
	<script type="text/javascript" src="js/views/new_note_details.js"></script>
    <script type="text/javascript" src="js/views/email_details.js"></script>
    <script type="text/javascript" src="js/views/home_medical_view.js"></script>
	...
	<script type="text/javascript" src="js/views/partie_cards.js"></script>
    <script type="text/javascript" src="js/views/person_details.js"></script>
    <script type="text/javascript" src="js/views/property_damage_details.js"></script>
	<script type="text/javascript" src="js/views/car_passenger_details.js"></script>
	<script type="text/javascript" src="js/views/notes_details.js"></script>
    <!--<script type="text/javascript" src="js/views/person_details.js"></script>-->
    <script type="text/javascript" src="js/views/rolodex_details.js"></script>
	<script type="text/javascript" src="js/views/setting_attach.js"></script>
    <script type="text/javascript" src="js/views/settlement_details.js"></script>
	<script type="text/javascript" src="js/views/setting_details.js"></script>
	<script type="text/javascript" src="js/views/signature_details.js"></script>
    <script type="text/javascript" src="js/views/stacks_details.js"></script>
    <script type="text/javascript" src="js/views/task_listing.js"></script>
	<script type="text/javascript" src="js/views/tasks_details.js"></script>
	...
	<script type="text/javascript" src="js/views/user_details.js"></script>
    <script type="text/javascript" src="js/views/user_setting_listing.js"></script>
    <script type="text/javascript" src="js/views/vservice_view.js"></script>
    <script type="text/javascript" src="js/views/vservices_view.js"></script>

    <script type="text/javascript" src="js/views/webmail_listing.js"></script>
    
    <!--modules-->
    <script type="text/javascript" src="js/chat_module.js"></script>
    <script type="text/javascript" src="js/event_module.js"></script>
    <script type="text/javascript" src="js/kase_module.js"></script>
    <script type="text/javascript" src="js/phone_message_module.js"></script>
