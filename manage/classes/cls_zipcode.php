...
class zipcode_class {
   ...
   function zipcode_class ($datalink) {
   ...
   function get_zip_details($zip) {
      ...
      $r = mysql_query($sql, $this->datalink) or die("unable to get zip lat/lon details<br>" . mysql_error());
      if (!$r) {
   ...
   function get_zip_list($zip) {
	...
	function get_zip_city($zip) {
      ...
      $result = mysql_query($sql, $this->datalink) or die("unable to get zip lat/lon details<br>" . mysql_error());
      if (!$result) {
         $this->last_error = mysql_error();
         return false;
      } else {
   ...
   function get_zip_point($zip) {
      ...
      $r = mysql_query($sql, $this->datalink) or die("unable to get zip lat/lon<br>" . mysql_error());
      if (!$r) {
         $this->last_error = mysql_error();
         return false;
      } else {
