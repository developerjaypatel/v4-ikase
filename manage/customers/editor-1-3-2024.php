      ...
      <tr>
        <td colspan="6" bgcolor="#EDEDED">
        	<div style="float:right">
                ...
                <?php } ?>
                <?php if ($blnImport && $data_path=="A1") { ?>
				<a href="import_a1_old.php?customer_id=<?php echo $cus_id; ?>&suid=<?php echo $suid; ?>" target="_blank">Import A2</a>&nbsp;|&nbsp;
                <?php } ?>
                <?php if ($blnImport && $data_path=="Abacus") { ?>
				<a href="import_abacus.php?customer_id=<?php echo $cus_id; ?>&suid=<?php echo $suid; ?>" target="_blank">Import Abacus</a>&nbsp;|&nbsp;
                <?php } ?>
