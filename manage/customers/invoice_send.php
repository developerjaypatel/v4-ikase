...
$filename = "https://www.ikase.org/manage/customers/invoice.php?invoice_id=" . $invoice_id . "&cus_id=" . $cus_id . "&suid=outstanding";
...
$seq = "";
$arrFiles[] = "https://www.ikase.org/" . $output_filename . "?dmsauth=" . urlencode($dmsauth);
/*
$seq = json_encode(array("cus_id"=>$cus_id, "invoice_id"=>$invoice_id, "dmsauth"=>urlencode($dmsauth)));
$arrFiles[] = "https://www.ikase.org/invoice.php?seq=" . base64_encode($seq);
*/
$arrFilesHTML[] = "<a href='https://www.ikase.org/outstanding/invoices.php?seq=" . base64_encode($seq) . "'>Click here for Print-Ready Invoice</a><br />
https://www.ikase.org/invoice.php?seq=" . base64_encode($seq);
