            ...
            <td align="left" valign="top">
           	  <div>
                    ...
                    <div style="display:inline-block">
                        ...
                        <input type="text" id="stack_case_<%=stack.document_id%>" class="kase_input" placeholder="Please Wait.." value="<%=stack.case_name %>" /><%=stack.case_link %>
                    </div>
              ...
              <tbody>
                ...
                <tr>
                  <td align="left" valign="top">
                    ...
                    <?php } else { ?>
                    <% if (customer_id == "1121") { //alert("here"); %>
                    		
						  	<select class="stack_input stack_type" name="stack_type_<%=stack.document_id%>2" id="stack_type_<%=stack.document_id%>">
                              <option value="" <% if (stack.type=="" && stack.type!="unassigned") { %>selected<% } %>>Select Type</option>
                              <option style="display:none" disabled="disabled" value="AME Report" <% if (stack.type=="AME Report") { %>selected<% } %>>AME Report</option>
                              <option style="display:none" disabled="disabled" value="Copy Service Request" <% if (stack.type=="Copy Service Request") { %>selected<% } %>>Copy Service Request</option>
                              <option style="display:none" disabled="disabled" value="COR" <% if (stack.type=="COR") { %>selected<% } %>>COR</option>
                              <option style="display:none" disabled="disabled" value="COR - C" <% if (stack.type=="COR - C") { %>selected<% } %>>COR - C</option>
                              <option value="COR - DA" <% if (stack.type=="COR - DA") { %>selected<% } %>>COR - DA</option>
                              <option value="COR - CLT" <% if (stack.type=="COR - CLT") { %>selected<% } %>>COR - CLT</option>
                              <option style="display:none" disabled="disabled" value="COR - IMR" <% if (stack.type=="COR - IMR") { %>selected<% } %>>COR - IMR</option>
                              ...
                              <option value="COR - LIEN" <% if (stack.type=="COR - LIEN") { %>selected<% } %>>COR - LIEN</option>
                              <option value="Depo Transcript" <% if (stack.type=="Depo Transcript") { %>selected<% } %>>Depo Transcript</option>
                              <option value="Fee Received" <% if (stack.type=="Fee Received") { %>selected<% } %>>Fee Received</option>
                              ...
                              <option style="display:none" disabled="disabled" value="Fax Received" <% if (stack.type=="Fax Received") { %>selected<% } %>>Fax Received</option>
                              <option style="display:none" disabled="disabled" value="Fax Sent" <% if (stack.type=="Fax Sent") { %>selected<% } %>>Fax Sent</option>
                              <option style="display:none" disabled="disabled" value="Fee" <% if (stack.type=="Fee") { %>selected<% } %>>Fee</option>
                              <option style="display:none" disabled="disabled" value="Letter Received" <% if (stack.type=="Letter Received") { %>selected<% } %>>Letter Received</option>
                              <option value="Letter Sent" <% if (stack.type=="Letter Sent") { %>selected<% } %>>Letter Sent</option>
                              <option style="display:none" disabled="disabled" value="Manual Entry" <% if (stack.type=="Manual Entry") { %>selected<% } %>>Manual Entry</option>
                              <option value="Medical Report" <% if (stack.type=="Medical Report") { %>selected<% } %>>Medical Report</option>
                              <option value="Medical" <% if (stack.type=="Medical") { %>selected<% } %>>Medical</option>
                              <option style="display:none" disabled="disabled" value="Misc" <% if (stack.type=="Misc") { %>selected<% } %>>Misc</option>
                              <option style="display:none" disabled="disabled" value="MPN" <% if (stack.type=="MPN") { %>selected<% } %>>MPN</option>
                              <option style="display:none" disabled="disabled" value="Note" <% if (stack.type=="Note") { %>selected<% } %>>Note</option>
                              <option style="display:none" disabled="disabled" value="P &amp; S Report" <% if (stack.type=="P & S Report") { %>selected<% } %>>P &amp; S Report</option>
                              <option style="display:none" disabled="disabled" value="Payment" <% if (stack.type=="Payment") { %>selected<% } %>>Payment</option>
                              <option value="Pleadings" <% if (stack.type=="Pleadings") { %>selected<% } %>>Pleadings</option>
                              <option style="display:none" disabled="disabled" value="POA/Attorney Meeting" <% if (stack.type=="POA/Attorney Meeting") { %>selected<% } %>>POA/Attorney Meeting</option>
                              <option style="display:none" disabled="disabled" value="PQME Report" <% if (stack.type=="PQME Report") { %>selected<% } %>>PQME Report</option>
                              <option style="display:none" disabled="disabled" value="Proof Sent" <% if (stack.type=="Proof Sent") { %>selected<% } %>>Proof Sent</option>
                              <option style="display:none" disabled="disabled" value="Reviewed" <% if (stack.type=="Reviewed") { %>selected<% } %>>Reviewed</option>
                              <option style="display:none" disabled="disabled" value="Scanned Mail" <% if (stack.type=="Scanned Mail" || stack.type=="unassigned") { %>selected<% } %>>Scanned Mail</option>
                              <option value="SDT Records" <% if (stack.type=="SDT Records") { %>selected<% } %>>SDT Records</option>
                              <option value="WCAB" <% if (stack.type=="WCAB") { %>selected<% } %>>WCAB</option>
                              <option value="APPT Notice" <% if (stack.type=="APPT Notice") { %>selected<% } %>>APPT Notice</option>
                              <option value="Pleadings" <% if (stack.type=="Pleadings") { %>selected<% } %>>Pleadings</option>
                              <option value="Settlement Docs" <% if (stack.type=="Settlement Docs") { %>selected<% } %>>Settlement Docs</option>
                              <option style="display:none" disabled="disabled" value="Telephone Call" <% if (stack.type=="Telephone Call") { %>selected<% } %>>Telephone Call</option>
                            </select>
					<% } else { %>
                    <select class="stack_input stack_type" name="stack_type_<%=stack.document_id%>2" id="stack_type_<%=stack.document_id%>">
                      <option value="" <% if (stack.type=="" && stack.type!="unassigned") { %>selected<% } %>>Select Type</option>
