...
<div class="import" style="padding-left:20px; ">
    <div style="position:absolute; z-index:9999; left:750px; top:5px; background:#CCC; padding:5px">
        <a href="https://www.ikase.org/uploads/batchscan_barcode_plain.pdf" target="_blank" title="Click here to print the New Separator Sheet" class="black_text" style="text-decoration:underline">Click here to print the New Separator Sheet</a>
        <br />
        ...
        <div id="batchscan_review" style="display:; width:100%">
            ...
            -->
            <a href="https://www.ikase.org/uploads/batchscan_barcode_plain.pdf" target="_blank" title="Click here to print the New Separator Sheet" class="black_text" style="text-decoration:underline"><img src="images/page.png" width="350px" height="auto" style="border:1px solid black"></a>
        </div>
    </div>
    <!--
    ...
    <iframe src="https://www.ikase.org/barcode/ikase_form.php" height="600" width="100%" allowtransparency="1" frameborder="0" scrolling="no">
    </iframe>
    <!--
