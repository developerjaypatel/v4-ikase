<div class="medicalbilling">
    <form id="medicalbilling_form" parsley-validate>
        <input id="table_name" name="table_name" type="hidden" value="medicalbilling" />
        <input id="table_id" name="table_id" type="hidden" value="<%=medicalbilling_id %>" />
...
<div id="medical_billing_view_done"></div>
<script language="javascript">
$( "#medical_billing_view_done" ).trigger( "click" );
</script>