        ...
        <form id="work_history_earnings_form" parsley-validate>
            ...
            <div class="gridster <?php echo $form_name; ?>" id="gridster_<?php echo $form_name; ?>" style="">
                ...
                <ul style="margin-bottom:10px">
                    ...
                    <?php //if ($_SERVER['REMOTE_ADDR'] == "174.193.220.7" || $_SERVER['REMOTE_ADDR'] == "174.193.141.228") { ?>
                        <li id="work_history_occupationGrid" data-row="3" data-col="1" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                            <h6><div class="form_label_vert" style="margin-top:10px;">Occupation</div></h6>
                            <div style="float:right; margin-right:5px" class="hidden" id="work_history_occupationSave">
                                <a class="save_field" title="Click to save this field" id="work_history_occupationSaveLink">
                                    <i class="glyphicon glyphicon-save"></i>
                                </a>
                            </div>
                            <input value="" name="work_history_occupationInput" id="work_history_occupationInput" class="<?php echo $form_name; ?> input_class hidden" placeholder="" style="margin-top:-26px; margin-left:70px; width:80px" parsley-error-message="" />
                            <span id="work_history_occupationSpan" class="<?php echo $form_name; ?> form_span_vert span_class" style="margin-top:-26px; margin-left:65px; border:0px solid black""></span>
                        </li>
                        <li id="work_history_paidtypeGrid" data-row="3" data-col="2" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                            <h6><div class="form_label_vert" style="margin-top:10px;">Paid Type</div></h6>
                            <div style="float:right; margin-right:5px" class="hidden" id="work_history_paidtypeSave">
                                <a class="save_field" title="Click to save this field" id="work_history_paidtypeSaveLink">
                                    <i class="glyphicon glyphicon-save"></i>
                                </a>
                            </div>
                            <select name="work_history_paidtypeInput" id="work_history_paidtypeInput" class="input_class hidden" style="height:25px; width:100px; margin-top:-30px; margin-left:70px" tabindex="0">
                        	<option value="" selected="selected">Select from List</option>
                            <option value="cash">Cash</option>
                            <option value="debit">Debit/Credit</option>
                        </select>
                            <span id="work_history_paidtypeSpan" class="<?php echo $form_name; ?> form_span_vert span_class" style="margin-top:-26px; margin-left:65px; border:0px solid black""></span>
                        </li>
                        <li id="work_history_hoursperweekGrid" data-row="4" data-col="1" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                            <h6><div class="form_label_vert" style="margin-top:10px;">Hours/Week</div></h6>
                            <div style="float:right; margin-right:5px" class="hidden" id="work_history_hoursperweekSave">
                                <a class="save_field" title="Click to save this field" id="work_history_hoursperweekSaveLink">
                                    <i class="glyphicon glyphicon-save"></i>
                                </a>
                            </div>
                            <input value="" name="work_history_hoursperweekInput" id="work_history_hoursperweekInput" class="<?php echo $form_name; ?> input_class hidden" placeholder="" style="margin-top:-26px; margin-left:70px; width:55px" parsley-error-message="" />
                            <span id="work_history_hoursperweekSpan" class="<?php echo $form_name; ?> form_span_vert span_class" style="margin-top:-26px; margin-left:65px; border:0px solid black""></span>
                        </li>
                        <li id="work_history_overtimeGrid" data-row="4" data-col="2" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                            <h6><div class="form_label_vert" style="margin-top:10px;">Overtime</div></h6>
                            <div style="float:right; margin-right:5px" class="hidden" id="work_history_overtimeSave">
                                <a class="save_field" title="Click to save this field" id="work_history_overtimeSaveLink">
                                    <i class="glyphicon glyphicon-save"></i>
                                </a>
                            </div>
                            <input value="" name="work_history_overtimeInput" id="work_history_overtimeInput" class="<?php echo $form_name; ?> input_class hidden" placeholder="" style="margin-top:-26px; margin-left:70px; width:55px" parsley-error-message="" />
                            <span id="work_history_overtimeSpan" class="<?php echo $form_name; ?> form_span_vert span_class" style="margin-top:-26px; margin-left:65px; border:0px solid black""></span>
                        </li>
                    <?php //} ?>
               </ul>
