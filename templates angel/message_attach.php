<div style="width:245px; position:relative" id="message_attach_holder">
    <div id="send_queue"></div>
    <div>
    <form class="message_attach_form">
    ...
    <button id="select_case_documents" style="cursor:pointer; display:none" class="btn btn-xs">Case Documents</button>
    </div>
