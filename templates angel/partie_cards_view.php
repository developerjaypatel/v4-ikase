    ...
    <div class="glass_header">
        ...
        <div style="float:right; margin-right:20px">
            ...
            <select id="file_location" style="display:none">
                ...
                <?php //die($customer); ?>
				<% if (customer_id == "1109") { %>
                <option value="Paperless Office">Paperless Office</option>
                <% } %>
                <% if (customer_id == "1134") { %>
                <option value="Hearing Cabinet">Hearing Cabinet</option>
                <option value="Reception Desk">Reception Desk</option>
                <option value="Richard Desk">Richard Desk</option>
                <option value="Mario Desk">Mario Desk</option>
        ...
        <div style="display:inline-block; text-align:left; vertical-align:top">
            ...
            <div style="">
                <button title="Click for New Party" id="new_partie" class="btn btn-sm btn-primary">
                    New Party
                </button>
            </div>
        </div>
        <div style="display:inline-block">
        	<div style="border:0px solid green; text-align:left">
                ...
                <a title="Click for New Party" id="new_partie" href='#parties/<%=case_id %>/-1/new' style="color:#FFFFFF; text-decoration:none;">
    	...
    	<% if (blnUseRightPane) { %>
        <div id="dashboard_right_pane" style="color:white;border:1px solid white;float: right;width: 200px;margin-top: 10px; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF; z-index:9999; display:none">
        Right Pane
        </div>
        <% } %>
