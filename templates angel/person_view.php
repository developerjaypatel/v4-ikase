    ...
    <form id="person_form" parsley-validate>
        ...
        <ul id="person_gridster_ul">
            ...
            <div style="margin-top:-26px; margin-left:60px; width:385px" class="kase person_view input_class hidden" id="ssn_div">
              <input name="ssn1" type="text" id="ssn1" value="<%= ssn1Display %>" style="width:27px" hidVal="" onkeyup="if(value.length==3){ssn2.focus();}" maxlength="3" placeholder="XXX" />&nbsp;<input name="ssn2" type="text" id="ssn2" value="<%= ssn2Display %>" style="width:20px" hidVal="" onkeyup="if(value.length==2){ssn3.focus();}" maxlength="2" placeholder="XX" />&nbsp;<input name="ssn3" type="text" id="ssn3" value="<%= ssn3Display %>" style="width:35px" hidVal="" maxlength="4" placeholder="XXXX" onkeyup="if(value.length==4){dobInput.focus();}" />
                </div>
      ...
      id="administrative_area_level_1_person" style="width:30px;border: 0px solid red" value="<%=state %>" />&nbsp;&nbsp;
           ...
           <li id="other_phoneGrid" data-row="9" data-col="1" data-sizex="8" data-sizey="1" class="gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            <h6><div class="form_label_vert" style="margin-top:10px;">Other Phone</div></h6>
              ...
              <input value="<%= other_phone %>" name="other_phoneInput" id="other_phoneInput" class="kase person_view input_class hidden" placeholder="" style="margin-top:-26px; margin-left:60px; width:385px" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" />
              <span id="other_phoneSpan" class="kase person_view span_class form_span_vert" style="margin-top:-28px; margin-left:65px"><%= other_phone %></span>
            </li>
