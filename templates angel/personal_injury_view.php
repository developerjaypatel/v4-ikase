...
<input id="right_outside"  name="right_outside" type="hidden" value="" class="input_class" />
        ...
        <ul>
            ...
            <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="makeSave">
              ...
              <input value="" name="makeInput" id="makeInput" class="kase personal_injury vehicle input_class hidden" style="margin-top:-25px; margin-left:85px; width:290px" tabindex="0" placeholder="Make" />
              <span id="makeSpan" class="personal_injury span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
            </li>
          <li id="yearGrid" data-row="2" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury vehicle gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="margin-top:-12px" class="save_holder hidden" id="yearSave">
              ...
              <input value="" name="yearInput" id="yearInput" class="personal_injury kase vehicle input_class hidden" placeholder="Year" style="margin-top:-25px; margin-left:85px; width:290px; border:0px solid red" autocomplete="off" tabindex="1" />
              <span id="yearSpan" class="personal_injury span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
            </li>
            <li id="modelGrid" data-row="3" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury vehicle gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
        ...
        <div style="margin-top:-12px" class="save_holder hidden" id="modelSave">
          ...
          <input value="" name="modelInput" id="modelInput" class="personal_injury kase vehicle input_class hidden" style="margin-top:-25px; margin-left:85px; width:290px" tabindex="2" placeholder="Model" />
          <span id="modelSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
        </li>
        <li id="license_plateGrid" data-row="4" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury vehicle gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
        ...
        <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="license_plateSave">
          ...
          <input value="" name="license_plateInput" id="license_plateInput" class="personal_injury vehicle input_class hidden" style="width:70px; margin-top:-25px; margin-left:85px; width:290px" tabindex="0" placeholder="Tags" />
          <span id="license_plateSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
        </li>
        <li id="vinGrid" data-row="5" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
        ...
        <div style="margin-top:-12px" class="save_holder hidden" id="vinSave">
          ...
          <input value="" name="vinInput" id="vinInput" class="personal_injury kase vehicle input_class hidden" placeholder="VIN" style="margin-top:-25px; margin-left:85px; width:290px; border:0px solid red" autocomplete="off" tabindex="1" />
          <span id="vinSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
        </li>
        <li id="vehicle_descriptionGrid" data-row="6" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
        ...
        <div style="margin-top:-12px" class="save_holder hidden" id="vehicle_descriptionSave">
          ...
          <input value="" name="vehicle_descriptionInput" id="vehicle_descriptionInput" class="personal_injury kase vehicle input_class hidden" placeholder="VIN" style="margin-top:-25px; margin-left:85px; width:290px; border:0px solid red" autocomplete="off" tabindex="1" />
          <span id="vehicle_descriptionSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
        </li>
     </ul>
     </form>
    </div>
    <% } else { %>
        ...
        <ul>
        	<li id="client_streetGrid" data-row="1" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury accident gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <input name="client_streetInput" id="client_streetInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:-26px; margin-left:60px; width:245px" />
              <span id="client_streetSpan" class="personal_injury span_class form_span_vert" style="margin-top:-25px; margin-left:60px"></span>
            </li>
            <li id="client_directionGrid" data-row="2" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury accident gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <input name="client_directionInput" id="client_directionInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:-26px; margin-left:60px; width:245px" />
              <span id="client_directionSpan" class="personal_injury span_class form_span_vert" style="margin-top:-25px; margin-left:60px"></span>
            </li>
            <li id="client_speedGrid" data-row="1" data-col="3" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="client_speedSave">
              ...
              <input value="" name="client_speedInput" id="client_speedInput" class="kase personal_injury accident_view input_class hidden" style="width:65px; margin-top:-25px; margin-left:85px" tabindex="0" />
              <span id="client_speedSpan" class="personal_injury span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
            </li>
          
            <li id="client_laneGrid" data-row="2" data-col="3" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
        ...
        <div style="margin-top:-12px" class="save_holder hidden" id="client_laneSave">
          ...
          <input value="" name="client_laneInput" id="client_laneInput" class="personal_injury kase accident_view input_class hidden" placeholder="Lane" style="margin-top:-25px; margin-left:85px; width:65px" tabindex="2" />
          <span id="client_laneSpan" class="kase personal_injury person_view span_class form_span_vert" style="margin-top:-30px; margin-left:90px"></span>
        </li>
        
        <li id="defendant_streetGrid" data-row="1" data-col="4" data-sizex="2" data-sizey="1" class="personal_injury accident gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
        ...
        <input name="defendant_streetInput" id="defendant_streetInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:-26px; margin-left:60px; width:245px" />
          <span id="defendant_streetSpan" class="personal_injury span_class form_span_vert" style="margin-top:-25px; margin-left:60px"></span>
        </li>
        <li id="defendant_directionGrid" data-row="2" data-col="4" data-sizex="2" data-sizey="1" class="personal_injury accident gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
        <h6><div class="form_label_vert" style="margin-top:10px;">Direction</div></h6>
        ...
        <input name="defendant_directionInput" id="defendant_directionInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:-26px; margin-left:60px; width:245px" />
          <span id="defendant_directionSpan" class="personal_injury span_class form_span_vert" style="margin-top:-25px; margin-left:60px"></span>
        </li>
        
        <li id="defendant_speedGrid" data-row="1" data-col="6" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
        ...
        <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="defendant_speedSave">
          ...
          <input value="" name="defendant_speedInput" id="defendant_speedInput" class="personal_injury input_class hidden" style="width:65px; margin-top:-25px; margin-left:85px" tabindex="0" />
          <span id="defendant_speedSpan" class="kase personal_injury accident_view span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
        </li>
        
        <li id="client_laneGrid" data-row="2" data-col="6" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
        <h6><div class="form_label_vert" style="margin-top:10px;">Lane</div></h6>
        <div style="margin-top:-12px" class="save_holder hidden" id="client_laneSave">
            <a class="save_field" style="margin-top:0px" title="Click to save this field" id="client_laneSaveLink">
                <i class="glyphicon glyphicon-save"></i>
          ...
          <input value="" name="defendant_laneInput" id="defendant_laneInput" class="personal_injury kase accident_view input_class hidden" placeholder="Lane" style="margin-top:-25px; margin-left:85px; width:65px" tabindex="2" />
          <span id="defendant_laneSpan" class="kase personal_injury accident_view span_class form_span_vert" style="margin-top:-30px; margin-left:90px"></span>
        </li>
        </ul>
        </form>
    </div>
    	...
    	<div style="background:url(../img/glass_card_fade_20_long.png); padding:5px; border:0px solid white; width:1000px; float:left;" id="gridster_acc_info_details" class="gridster">
            ...
            <ul>
                <li id="clear_liabilityGrid" data-row="1" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="clear_liabilitySave">
                  ...
                  <input type="checkbox" value="" name="clear_liabilityInput" id="clear_liabilityInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px;margin-top:-20px;" />
                  <span id="clear_liabilitySpan" class="personal_injury span_class form_span_vert" style="margin-top:-28px; margin-left:95px; border:0px solid black""></span>
            </li>
            <li id="police_calledGrid" data-row="1" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="police_calledSave">
                  ...
                  <input type="checkbox" value="" name="police_calledInput" id="police_calledInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px; margin-top:-20px" />
                  <span id="police_calledSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:95px; border:0px solid black"></span>
            </li>
            <li id="no_notice_warningGrid" data-row="1" data-col="3" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="no_notice_warningSave">
                  ...
                  <input type="checkbox" value="" name="no_notice_warningInput" id="no_notice_warningInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px; margin-top:-20px" />
                  <span id="no_notice_warningSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:95px; border:0px solid black""></span>
            </li>
            <li id="similar_priorGrid" data-row="1" data-col="4" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="similar_priorSave">
                  ...
                  <input type="checkbox" value="" name="similar_priorInput" id="similar_priorInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px; margin-top:-20px" />
                  <span id="similar_priorSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:95px; border:0px solid black"></span>
            </li>
            <li id="injury_erGrid" data-row="1" data-col="5" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="injury_erSave">
                  ...
                  <input type="checkbox" value="" name="injury_erInput" id="injury_erInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:65px; margin-top:-20px" />
                  <span id="injury_erSpan" class="personal_injury span_class form_span_vert span_perm" style="margin-top:-26px; margin-left:95px; border:0px solid black""></span>
            </li>
            <li id="injury_ambulanceGrid" data-row="1" data-col="6" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="injury_ambulanceSave">
                  ...
                  <input type="checkbox" value="" name="injury_ambulanceInput" id="injury_ambulanceInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px; margin-top:-20px" />
                  <span id="injury_ambulanceSpan" class="personal_injury span_class form_span_vert span_perm" style="margin-top:-26px; margin-left:95px; border:0px solid black"></span>
            </li>
            <!-- <li id="consent_formGrid" data-row="2" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="consent_formSave">
                  ...
                  <input type="checkbox" value="" name="consent_formInput" id="consent_formInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px; margin-top:-20px" />
                  <span id="consent_formSpan" class="personal_injury span_class form_span_vert span_perm" style="margin-top:-26px; margin-left:95px; border:0px solid black""></span>
            </li>
            <li id="adr_agreementGrid" data-row="2" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="adr_agreementSave">
                  ...
                  <input type="checkbox" value="" name="adr_agreementInput" id="adr_agreementInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px; margin-top:-20px" />
                  <span id="adr_agreementSpan" class="personal_injury span_class form_span_vert span_perm" style="margin-top:-26px; margin-left:95px; border:0px solid black"></span>
            </li>
            <li id="scene_photosGrid" data-row="2" data-col="3" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="scene_photosSave">
                  ...
                  <input type="checkbox" value="" name="scene_photosInput" id="scene_photosInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px; margin-top:-20px" />
                  <span id="scene_photosSpan" class="personal_injury span_class form_span_vert span_perm" style="margin-top:-26px; margin-left:95px; border:0px solid black""></span>
            </li>
            <li id="injury_photosGrid" data-row="2" data-col="4" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="injury_photosSave">
                  ...
                  <input type="checkbox" value="" name="injury_photosInput" id="injury_photosInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px; margin-top:-20px" />
                  <span id="injury_photosSpan" class="personal_injury span_class form_span_vert span_perm" style="margin-top:-26px; margin-left:95px; border:0px solid black"></span>
            </li>
            <li id="prop_damage_photosGrid" data-row="2" data-col="5" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="prop_damage_photosSave">
                  ...
                  <input type="checkbox" value="" name="prop_damage_photosInput" id="prop_damage_photosInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:65px; margin-top:-20px" />
                  <span id="prop_damage_photosSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:95px; border:0px solid black""></span>
            </li>
            <li id="scene_diagramGrid" data-row="2" data-col="6" data-sizex="1" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                ...
                <div style="float:right; margin-right:5px" class="hidden" id="scene_diagramSave">
                  ...
                  <input type="checkbox" value="" name="scene_diagramInput" id="scene_diagramInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px; margin-top:-20px" />
                  <span id="scene_diagramSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:95px; border:0px solid black"></span>
            </li> -->
            </ul>
            <div style="margin-top:0px; margin-left:10px; padding-top:5px">            
            ...
            <ul>
            	<li id="report_numberGrid" data-row="1" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="float:right; margin-right:5px" class="hidden" id="report_numberSave">
                      ...
                      <input value="" name="report_numberInput" id="report_numberInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:-26px; margin-left:60px; width:245px" />
                      <span id="report_numberSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:95px; border:0px solid black"></span>
                </li>
                <li id="citation_numberGrid" data-row="1" data-col="3" data-sizex="2" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="float:right; margin-right:5px" class="hidden" id="citation_numberSave">
                      ...
                      <input value="" name="citation_numberInput" id="citation_numberInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:-26px; margin-left:60px; width:245px" />
                      <span id="citation_numberSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:95px; border:0px solid black"></span>
                </li>
                <li id="citation_detailsGrid" data-row="1" data-col="6" data-sizex="2" data-sizey="1" class="personal_injury gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="float:right; margin-right:5px" class="hidden" id="citation_detailsSave">
                      ...
                      <input value="" name="citation_detailsInput" id="citation_detailsInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:-26px; margin-left:60px; width:245px" />
                      <span id="citation_detailsSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:95px; border:0px solid black"></span>
                </li>
            </ul>
            </form>
    </div>
    	...
    	<div style="border:0px solid green; color:#FFF">
                ...
                <div style="background:url(../img/glass_card_fade_19.png); padding:5px; border:0px solid white; width:auto;" id="gridster_accident" class="gridster">
                    ...
                    <ul>
                        ...
                        <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="makeSave">
                          ...
                          <input value="" name="makeInput" id="makeInput" class="kase personal_injury vehicle input_class hidden" style="margin-top:-25px; margin-left:85px; width:340px; " tabindex="0" placeholder="Make" />
                          <span id="makeSpan" class="personal_injury span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                      
                        <li id="modelGrid" data-row="2" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury vehicle gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        <h6><div class="form_label_vert" style="margin-top:10px;">Model</div></h6>
                        <div style="margin-top:-12px" class="save_holder hidden" id="modelSave">
                            <a class="save_field" style="margin-top:0px" title="Click to save this field" id="modelSaveLink">
                                <i class="glyphicon glyphicon-save"></i>
                          ...
                          <input value="" name="modelInput" id="modelInput" class="personal_injury kase vehicle input_class hidden" style="margin-top:-25px; margin-left:85px; width:340px" tabindex="2" placeholder="Model" />
                          <span id="modelSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                        <li id="yearGrid" data-row="3" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury vehicle gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        <h6><div class="form_label_vert" style="margin-top:10px;">Year</div></h6>
                        <div style="margin-top:-12px" class="save_holder hidden" id="yearSave">
                            <a class="save_field" style="margin-top:0px" title="Click to save this field" id="yearSaveLink">
                                <i class="glyphicon glyphicon-save"></i>
                          ...
                          <input value="" name="yearInput" id="yearInput" class="personal_injury kase vehicle input_class hidden" placeholder="Year" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                          <span id="yearSpan" class="personal_injury span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                      </li>
                      <li id="license_plateGrid" data-row="3" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury vehicle gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        <h6><div class="form_label_vert" style="margin-top:10px;">Tags</div></h6>
                        <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="license_plateSave">
                            <a class="save_field" style="margin-top:0px;" title="Click to save this field" id="license_plateSaveLink">
                                <i class="glyphicon glyphicon-save"></i>
                          ...
                          <input value="" name="license_plateInput" id="license_plateInput" class="personal_injury vehicle input_class hidden" style="width:70px; margin-top:-25px; margin-left:85px; width:100px" tabindex="0" placeholder="Tags" />
                          <span id="license_plateSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                        <li id="vinGrid" data-row="3" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        <h6><div class="form_label_vert" style="margin-top:10px;">VIN</div></h6>
                        <div style="margin-top:-12px" class="save_holder hidden" id="vinSave">
                            <a class="save_field" style="margin-top:0px" title="Click to save this field" id="vinSaveLink">
                                <i class="glyphicon glyphicon-save"></i>
                          ...
                          <input value="" name="vinInput" id="vinInput" class="personal_injury kase vehicle input_class hidden" placeholder="VIN" style="margin-top:-25px; margin-left:85px; width:340px; border:0px solid red" autocomplete="off" tabindex="1" />
                          <span id="vinSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                        <li id="vehicle_descriptionGrid" data-row="4" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        <h6><div class="form_label_vert" style="margin-top:10px;">Description</div></h6>
                        <div style="margin-top:-12px" class="save_holder hidden" id="vehicle_descriptionSave">
                            <a class="save_field" style="margin-top:0px" title="Click to save this field" id="vehicle_descriptionSaveLink">
                                <i class="glyphicon glyphicon-save"></i>
                          ...
                          <input value="" name="vehicle_descriptionInput" id="vehicle_descriptionInput" class="personal_injury kase vehicle input_class hidden" placeholder="Description" style="margin-top:-25px; margin-left:85px; width:340px; border:0px solid red" autocomplete="off" tabindex="1" />
                          <span id="vehicle_descriptionSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                        
                        <li id="vehicle_colorGrid" data-row="5" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        ...
                        <div style="margin-top:-12px" class="save_holder hidden" id="vehicle_colorSave">
                          ...
                          <input value="" name="vehicle_colorInput" id="vehicle_colorInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                          <span id="vehicle_colorSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                        <li id="vehicle_typeGrid" data-row="5" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        ...
                        <div style="margin-top:-12px" class="save_holder hidden" id="vehicle_typeSave">
                          ...
                          <select name="vehicle_typeInput" id="vehicle_typeInput" class="personal_injury kase vehicle input_class hidden"style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" tabindex="1">
                          ...
                          <span id="vehicle_typeSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                        <li id="vehicle_commentsGrid" data-row="6" data-col="1" data-sizex="2" data-sizey="3" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        ...
                        <div style="margin-top:-12px" class="save_holder hidden" id="vehicle_commentsSave">
                          ...
                          <textarea name="vehicle_commentsInput" id="vehicle_commentsInput" class="personal_injury kase vehicle input_class hidden" placeholder="Any additional info..." style="margin-left:85px; width:340px; height:100px; border:0px solid red" autocomplete="off" tabindex="1"></textarea>
                          <span id="vehicle_commentsSpan" class="kase personal_injury vehicle span_class form_span_vert" style=" margin-left:90px"></span>
                        </li>
                        <li id="damagesGrid" data-row="7" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        ...
                        <div style="margin-top:-12px" class="save_holder hidden" id="damagesSave">
                          ...
                          <input type="number" value="" name="damagesInput" id="damagesInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                          <span id="damagesSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                        
                        <li id="towingGrid" data-row="7" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        ...
                        <div style="margin-top:-12px" class="save_holder hidden" id="towingSave">
                          ...
                          <input type="number" value="" name="towingInput" id="towingInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                          <span id="towingSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                        
                        <li id="storageGrid" data-row="8" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        ...
                        <div style="margin-top:-12px" class="save_holder hidden" id="storageSave">
                          ...
                          <input type="number" value="" name="storageInput" id="storageInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                          <span id="storageSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                        
                        <li id="lossesGrid" data-row="8" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        ...
                        <div style="margin-top:-12px" class="save_holder hidden" id="lossesSave">
                          ...
                          <input type="number" value="" name="lossesInput" id="lossesInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                          <span id="lossesSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                        
                        <li id="damage_detailsGrid" data-row="9" data-col="1" data-sizex="2" data-sizey="3" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        ...
                        <div style="margin-top:-12px" class="save_holder hidden" id="damage_detailsSave">
                          ...
                          <textarea name="damage_detailsInput" id="damage_detailsInput" class="personal_injury kase vehicle input_class hidden" placeholder="Details of damage" style="margin-left:85px; width:340px; height:100px; border:0px solid red" autocomplete="off" tabindex="1"></textarea>
                          <span id="damage_detailsSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                 </ul>
                 <!--
                 <ul style="display:none">
                    <li id="rental_coverageGrid" data-row="4" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="rental_coverageSave">
                      ...
                      <input value="" name="rental_coverageInput" id="rental_coverageInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:340px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="rental_coverageSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="rental_amountGrid" data-row="5" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="rental_amountSave">
                      ...
                      <input value="" name="rental_amountInput" id="rental_amountInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="rental_amountSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="rental_daysGrid" data-row="5" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="rental_daysSave">
                      ...
                      <input value="" name="rental_daysInput" id="rental_daysInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="rental_daysSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="coverage_disputedGrid" data-row="6" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="coverage_disputedSave">
                      ...
                      <input value="" type="checkbox" name="coverage_disputedInput" id="coverage_disputedInput" class="personal_injury kase vehicle input_class hidden" style="margin-top:-25px; margin-left:45px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="coverage_disputedSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="liab_coll_onlyGrid" data-row="6" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="liab_coll_onlySave">
                      ...
                      <input value="" name="liab_coll_onlyInput" id="liab_coll_onlyInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="liab_coll_onlySpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="vehicle_totaledGrid" data-row="7" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="vehicle_totaledSave">
                      ...
                      <input type="checkbox" value="" name="vehicle_totaledInput" id="vehicle_totaledInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:45px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="vehicle_totaledSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="coll_deductibleGrid" data-row="7" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="coll_deductibleSave">
                      ...
                      <input value="" name="coll_deductibleInput" id="coll_deductibleInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="coll_deductibleSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="umbrella_policyGrid" data-row="6" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="umbrella_policySave">
                      ...
                      <input value="" name="umbrella_policyInput" id="umbrella_policyInput" class="personal_injury kase vehicle input_class hidden" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="umbrella_policySpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="statement_recordedGrid" data-row="7" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="statement_recordedSave">
                      ...
                      <input value="" name="statement_recordedInput" id="statement_recordedInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="statement_recordedSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="client_statementSave">
                      ...
                      <input value="" name="client_statementInput" id="client_statementInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="client_statementSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    </ul>
                 -->
                    </form>
            ...
            <div style="float:right; border:0px solid red" id="defendant_car_information">
                ...
                <div style="background:url(../img/glass_card_fade_19.png); padding:5px; border:0px solid white; width:auto;	" id="gridster_accident" class="gridster">
                    ...
                    <input id="table_name" name="table_name" type="hidden" value="vehicle" />
                    <ul>
                        <li id="defendant_makeGrid" data-row="1" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        <h6><div class="form_label_vert" style="margin-top:10px;">Make</div></h6>
                        <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="defendant_makeSave">
                          ...
                          <input value="" name="defendant_makeInput" id="defendant_makeInput" class="kase personal_injury vehicle input_class hidden" style="margin-top:-25px; margin-left:85px; width:340px" tabindex="0" placeholder="Make" />
                          <span id="defendant_makeSpan" class="personal_injury span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                        </li>
                      
                        <li id="defendant_modelGrid" data-row="2" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury vehicle gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Model</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_modelSave">
                      ...
                      <input value="" name="defendant_modelInput" id="defendant_modelInput" class="personal_injury kase vehicle input_class hidden" style="margin-top:-25px; margin-left:85px; width:340px" tabindex="2" placeholder="Model" />
                      <span id="defendant_modelSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_yearGrid" data-row="3" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury vehicle gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                        <h6><div class="form_label_vert" style="margin-top:10px;">Year</div></h6>
                        <div style="margin-top:-12px" class="save_holder hidden" id="defendant_yearSave">
                          ...
                          <input value="" name="defendant_yearInput" id="defendant_yearInput" class="personal_injury kase vehicle input_class hidden" placeholder="Year" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                          <span id="defendant_yearSpan" class="personal_injury span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                      </li>
                    <li id="defendant_license_plateGrid" data-row="3" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury vehicle gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Tags</div></h6>
                    <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="defendant_license_plateSave">
                      ...
                      <input value="" name="defendant_license_plateInput" id="defendant_license_plateInput" class="personal_injury vehicle input_class hidden" style="width:70px; margin-top:-25px; margin-left:85px; width:100px" tabindex="0" placeholder="Tags" />
                      <span id="defendant_license_plateSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_vinGrid" data-row="3" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">VIN</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_vinSave">
                      ...
                      <input value="" name="defendant_vinInput" id="defendant_vinInput" class="personal_injury kase vehicle input_class hidden" placeholder="VIN" style="margin-top:-25px; margin-left:85px; width:340px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_vinSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_vehicle_descriptionSave">
                      ...
                      <input value="" name="defendant_vehicle_descriptionInput" id="defendant_vehicle_descriptionInput" class="personal_injury kase vehicle input_class hidden" placeholder="Description" style="margin-top:-25px; margin-left:85px; width:340px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_vehicle_descriptionSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    
                    <li id="defendant_vehicle_colorGrid" data-row="5" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Color</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_vehicle_colorSave">
                      ...
                      <input value="" name="defendant_vehicle_colorInput" id="defendant_vehicle_colorInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_vehicle_colorSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_vehicle_typeGrid" data-row="5" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Type</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_vehicle_typeSave">
                      ...
                      <select name="defendant_vehicle_typeInput" id="defendant_vehicle_typeInput" class="personal_injury kase vehicle input_class hidden"style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" tabindex="1">
                      	<option value="">Select from list...</option>
                        <option value="car">Car</option>
                        <option value="truck">Truck</option>
                        <option value="motorcycle">Motorcycle</option>
                      ...
                      <span id="defendant_vehicle_typeSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_vehicle_commentsGrid" data-row="6" data-col="1" data-sizex="2" data-sizey="3" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Additional Info</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_vehicle_commentsSave">
                      ...
                      <textarea name="defendant_vehicle_commentsInput" id="defendant_vehicle_commentsInput" class="personal_injury kase vehicle input_class hidden" placeholder="Any additional info..." style="margin-left:85px; width:340px; height:100px; border:0px solid red" autocomplete="off" tabindex="1"></textarea>
                      <span id="defendant_vehicle_commentsSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_damagesGrid" data-row="7" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Damages ($)</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_damagesSave">
                      ...
                      <input type="number" value="" name="damagesInput" id="defendant_damagesInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_damagesSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    
                    <li id="defendant_towingGrid" data-row="7" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Towing ($)</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_towingSave">
                      ...
                      <input type="number" value="" name="towingInput" id="defendant_towingInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_towingSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    
                    <li id="defendant_storageGrid" data-row="8" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Storage ($)</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_storageSave">
                      ...
                      <input type="number" value="" name="storageInput" id="defendant_storageInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_storageSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    
                    <li id="defendant_lossesGrid" data-row="8" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Losses ($)</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_lossesSave">
                      ...
                      <input type="number" value="" name="lossesInput" id="defendant_lossesInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_lossesSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_damage_detailsGrid" data-row="9" data-col="1" data-sizex="2" data-sizey="3" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Damage Details</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_damage_detailsSave">
                      ...
                      <textarea name="defendant_damage_detailsInput" id="defendant_damage_detailsInput" class="personal_injury kase vehicle input_class hidden" placeholder="Details of damage" style="margin-left:85px; width:340px; height:100px; border:0px solid red" autocomplete="off" tabindex="1"></textarea>
                      <span id="defendant_damage_detailsSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                 </ul>
                 <ul style="display:none">
                    <li id="defendant_rental_coverageGrid" data-row="4" data-col="1" data-sizex="2" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Rental Cov.</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_rental_coverageSave">
                      ...
                      <input value="" name="defendant_rental_coverageInput" id="defendant_rental_coverageInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:340px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_rental_coverageSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_rental_amountGrid" data-row="5" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Amount</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_rental_amountSave">
                      ...
                      <input value="" name="defendant_rental_amountInput" id="defendant_rental_amountInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_rental_amountSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_rental_daysGrid" data-row="5" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Days</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_rental_daysSave">
                      ...
                      <input value="" name="defendant_rental_daysInput" id="defendant_rental_daysInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_rental_daysSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_coverage_disputedGrid" data-row="6" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Cov. Disputed</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_coverage_disputedSave">
                      ...
                      <input value="" type="checkbox" name="defendant_coverage_disputedInput" id="defendant_coverage_disputedInput" class="personal_injury kase vehicle input_class hidden" style="margin-top:-25px; margin-left:45px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_coverage_disputedSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_liab_coll_onlyGrid" data-row="6" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Liab/Coll Only</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_liab_coll_onlySave">
                      ...
                      <input value="" name="defendant_liab_coll_onlyInput" id="defendant_liab_coll_onlyInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_liab_coll_onlySpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_vehicle_totaledSave">
                      ...
                      <input type="checkbox" value="" name="defendant_vehicle_totaledInput" id="defendant_vehicle_totaledInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:45px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_vehicle_totaledSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_coll_deductibleGrid" data-row="7" data-col="2" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Coll Deductible</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_coll_deductibleSave">
                      ...
                      <input value="" name="defendant_coll_deductibleInput" id="defendant_coll_deductibleInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_coll_deductibleSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_umbrella_policyGrid" data-row="6" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Umbrella</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_umbrella_policySave">
                      ...
                      <input value="" name="defendant_umbrella_policyInput" id="defendant_umbrella_policyInput" class="personal_injury kase vehicle input_class hidden" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_umbrella_policySpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    <li id="defendant_statement_recordedGrid" data-row="7" data-col="1" data-sizex="1" data-sizey="1" class="personal_injury accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
                    <h6><div class="form_label_vert" style="margin-top:10px;">Stmnt Rec</div></h6>
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_statement_recordedSave">
                      ...
                      <input type="checkbox" value="" name="defendant_statement_recordedInput" id="defendant_statement_recordedInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:45px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_statement_recordedSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
                    </li>
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_client_statementSave">
                      ...
                      <input value="" name="defendant_client_statementInput" id="defendant_client_statementInput" class="personal_injury kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                      <span id="defendant_client_statementSpan" class="kase personal_injury vehicle span_class form_span_vert" style="margin-top:-28px; margin-left:26px"></span>
                    </li>
                    </ul>
                    </form>
                </div>
...
<div class="personal_injury" id="personal_injury_panel">
    ...
    <div style="margin-top:0px; margin-right:10px; padding-top:5px">            
    	<% kase_type = case_type; %><?php 
		$form_name = "personal_injury";
        include("dashboard_view_navigation.php"); 
        ?></div>
    <div class="gridster personal_injury" id="gridster_personal_injury" style="">
        ...
        <ul style="margin-bottom:10px">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="personal_injury_dateSave">
              ...
              <input value="" name="personal_injury_dateInput" id="personal_injury_dateInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:-26px; margin-left:75px; width:385px" autocomplete="off" parsley-error-message="Req" required />
              <span id="personal_injury_dateSpan" class="kase personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:85px"></span>
        </li>
        ...
        <li id="personal_injury_dayGrid" data-row="2" data-col="1" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <span id="personal_injury_daySpan" class="personal_injury form_span_vert span_perm" style="margin-top:-26px; margin-left:75px; border:0px solid black""></span>
              <input type="hidden" value="" name="personal_injury_dayInput" id="personal_injury_dayInput" class="personal_injury input_class hidden" placeholder="Day" style="margin-left:75px;" />
		...
		<li id="personal_injury_timeGrid" data-row="2" data-col="2" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <span id="personal_injury_timeSpan" class="personal_injury form_span_vert span_perm" style="margin-top:-26px; margin-left:75px; border:0px solid black"></span>
              <input type="hidden" value="" name="personal_injury_timeInput" id="personal_injury_timeInput" class="personal_injury input_class hidden" placeholder="Time" style="margin-left:75px" />
        ...
        <li id="personal_injury_loss_dateGrid" data-row="3" data-col="1" data-sizex="2" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="personal_injury_loss_dateSave">
              ...
              <input value="" name="personal_injury_loss_dateInput" id="personal_injury_loss_dateInput" class="personal_injury input_class hidden" placeholder="Date of Loss" style="margin-top:-26px; margin-left:75px; width:100px" />
              <span id="personal_injury_loss_dateSpan" class="kase personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:75px"></span>
        </li>
        -->
        <li id="personal_injury_locationGrid" data-row="3" data-col="1" data-sizex="2" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="personal_injury_locationSave">
              ...
              <input value="" name="personal_injury_locationInput" id="personal_injury_locationInput" class="personal_injury input_class hidden" placeholder="Location" style="margin-top:-26px; margin-left:75px; width:385px" />
              <span id="personal_injury_locationSpan" class="kase personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:65px"></span>
        ...
        <li id="personal_injury2_locationGrid" data-row="3" data-col="1" data-sizex="2" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="personal_injury2_locationSave">
              ...
              <input value="" name="personal_injury2_locationInput" id="personal_injury2_locationInput" class="personal_injury input_class hidden" placeholder="Location" style="margin-top:-26px; margin-left:75px; width:385px" />
              <span id="personal_injury2_locationSpan" class="kase personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:65px"></span>
        ...
        <div style="float:right; margin-right:5px" class="hidden" id="personal_injury_countySave">
            <a class="save_field" title="Click to save this field" id="personal_injury_countySaveLink">
                ...
                <input value="" name="personal_injury_countyInput" id="personal_injury_countyInput" class="personal_injury input_class hidden" type="text" style="margin-top:-26px; margin-left:75px; width:100px" />
          <span id="personal_injury_countySpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:75px"></span>
        </li>
		...
		<li id="personal_injury_accident_descriptionGrid" data-row="4" data-col="1" data-sizex="2" data-sizey="10" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="user_logonSave">
              ...
              <textarea name="personal_injury_accident_descriptionInput" id="personal_injury_accident_descriptionInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:0px; margin-left:3px; width:445px; height:420px" ></textarea>
              <span id="personal_injury_accident_descriptionSpan" class="personal_injury span_class form_span_vert" style="margin-top:-6pxx"></span>
        </li>
        ...
        <li id="personal_injury_other_detailsGrid" data-row="4" data-col="1" data-sizex="2" data-sizey="5" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="user_logonSave">
              ...
              <textarea name="personal_injury_other_detailsInput" id="personal_injury_other_detailsInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:0px; margin-left:3px; width:445px" rows="7"></textarea>
              <span id="personal_injury_other_detailsSpan" class="personal_injury span_class form_span_vert" style="margin-top:-6px;"></span>
        </li>
        <li id="personal_injury_accident_injuriesGrid" data-row="5" data-col="1" data-sizex="2" data-sizey="5" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="user_logonSave">
              ...
              <textarea name="personal_injury_accident_injuriesInput" id="personal_injury_accident_injuriesInput" class="personal_injury input_class hidden" placeholder="" style="margin-top:0px; margin-left:3px; width:445px; height:190px" tabindex="4"></textarea>
              <span id="personal_injury_accident_injuriesSpan" class="personal_injury span_class form_span_vert" style="margin-top:-6px;"></span>
        </li>
        ...
        <li id="client_fault_percentageGrid" data-row="11" data-col="1" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="client_fault_percentageSave">
              ...
              <input type="number" value="" name="client_fault_percentageInput" id="client_fault_percentageInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:70px; margin-top:-24px; width:145px" />
              <span id="client_fault_percentageSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:70px; border:0px solid black""></span>
        </li>
		<li id="premises_conditionGrid" data-row="11" data-col="2" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="premises_conditionSave">
              ...
              <input type="text" value="" name="premises_conditionInput" id="premises_conditionInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:115px; margin-top:-24px; width:100px" />
              <span id="premises_conditionSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:70px; border:0px solid black"></span>
        </li>
        <li id="personal_injury_typeGrid" data-row="12" data-col="1" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="personal_injury_typeSave">
              ...
              <input type="text" value="" name="personal_injury_typeInput" id="personal_injury_typeInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:70px; margin-top:-24px; width:145px" />
              <span id="personal_injury_typeSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:70px; border:0px solid black""></span>
        </li>
		<li id="lightingGrid" data-row="12" data-col="2" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="lightingSave">
              ...
              <input type="text" value="" name="lightingInput" id="lightingInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:115px; margin-top:-24px; width:100px" />
              <span id="lightingSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:70px; border:0px solid black"></span>
        </li>
        <li id="injury_location_typeGrid" data-row="13" data-col="1" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="injury_location_typeSave">
              ...
              <select name="injury_location_type" id="injury_location_type" class="personal_injury input_class hidden" style="margin-left:70px; margin-top:-24px; width:145px">
              ...
              <span id="injury_location_typeSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:95px; border:0px solid black""></span>
        </li>
        <li id="government_propGrid" data-row="13" data-col="2" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <div style="float:right; margin-right:5px" class="hidden" id="government_propSave">
              ...
              <input type="checkbox" value="" name="government_propInput" id="government_propInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:75px; margin-top:-20px" />
              <span id="government_propSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:95px; border:0px solid black""></span>
        </li>
        <li id="natureGrid" data-row="14" data-col="1" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <input type="text" value="" name="natureInput" id="natureInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:65px; margin-top:-24px; width:145px" />
            <span id="natureSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:75px; border:0px solid black"></span>
		...
		<li id="controlsGrid" data-row="14" data-col="2" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <input type="text" value="" name="controlsInput" id="controlsInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:65px; margin-top:-24px; width:145px" />
            <span id="controlsSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:75px; border:0px solid black"></span>
        ...
        <li id="weatherGrid" data-row="15" data-col="1" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <input type="text" value="" name="weatherInput" id="weatherInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:65px; margin-top:-24px; width:145px" />
            <span id="weatherSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:75px; border:0px solid black"></span>
        ...
        <li id="pi_otherGrid" data-row="15" data-col="2" data-sizex="1" data-sizey="1" class="gridster_border kase" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            ...
            <input type="text" value="" name="pi_otherInput" id="pi_otherInput" class="personal_injury input_class hidden" placeholder="" style="margin-left:65px; margin-top:-24px; width:145px" />
            <span id="pi_otherSpan" class="personal_injury span_class form_span_vert" style="margin-top:-26px; margin-left:75px; border:0px solid black"></span>
