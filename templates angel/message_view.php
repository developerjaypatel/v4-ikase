...
<div style="width:350px; display:none; float:right; border:1px solid white; overflow-y:auto" id="message_documents_list"></div>
...
<table width="550" border="0" align="left" cellpadding="2" cellspacing="0" id="message_holder_table">
  <tr>
    ...
    <td colspan="2" valign="top">
    	<div id="auto_case_override" style="display:none; float:right">
  ...
  <tr>
    ...
    <td width="45%" rowspan="3" valign="top">
        ...
        <div id="message_attachments" style="width:250px; overflow-y:auto"></div>
    </td>
    </tr>
  <tr class="cc_row">
    <th align="left" valign="top" scope="row"><span class='show_users' title="Click to select from Employees list">Cc</span>&nbsp;:</th>
    <td style="border:#FF0000 0px solid" valign="top" id="message_cc_td">
  ...
  <tr class="cc_row">
    ...
    <td style="border:#FF0000 0px solid" valign="top" id="message_cc_td3"><input name="message_bccInput" type="text" id="message_bccInput" class="modalInput interoffice input_class" />
  ...
  <tr>
    ...
    <td colspan="2"><input name="subjectInput" type="text" id="subjectInput" style="width:488px" class="modalInput" parsley-error-message="" value="<%=subject %>" autocomplete="off" required /></td>
    </tr>
  <tr>
  ...
  <tr>
    <th colspan="3" align="left" valign="top" scope="row">
        <div style="float:right;width:10px;height:270px;border:0px solid red"></div>
