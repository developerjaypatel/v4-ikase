...
$sql = "SELECT 'applicant', full_name, company_name, dob, full_address, street, suite, city, state, zip 
FROM cse_person
WHERE 1
AND MONTH(dob) = '" . $month . "'
...
SELECT 'plaintiff', full_name, company_name, dob, full_address, street, suite, city, state, zip 
...
alert("Ready to print. \r\n\r\nFound <?php echo count($clients); ?> clients");
</script>