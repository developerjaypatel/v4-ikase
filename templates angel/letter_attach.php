<span style="color:#FFFFFF; font-size:1.25em; font-weight:lighter; margin-left:3px;" id="import_title">Attachments</span>
<div id="send_queue"></div>
<div>
<form class="letter_attach_form">
    ...
    <div id="queue" style="width:90%"></div>
</form>
</div>
