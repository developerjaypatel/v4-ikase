...
<div id="announcements">
        ...
        <div style="margin-top:10px; width:100%; border-bottom:0px solid #CCC; padding:5px; background:#333">
            ...
            <p>Please click here for the <a href="https://v2.ikase.org/batchscan_barcode_plain.pdf" target="_blank" title="Click here to print the Separator Sheet" class="white_text" style="text-decoration:underline"><span class="announcement_highlight">iKase Separator Sheet</span></a></p>
        </div>
