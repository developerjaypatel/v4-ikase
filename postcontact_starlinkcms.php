...
$secret = "6LfikoQpAAAAANuCar6WfxAHaNIApZAScYZad2De";
$verifyResponse = 
...
$arrMessage[] = "StarLinkCMS Customer:" . $existing;
if ($firm!="") {
...
$from_name = "StarLinkCMS (v2) System";
$subject = "Website Contact Form :: StarLinkCMS (v2)";
$arrRecipients[] = $email;
$arrEmailTo = array();
$arrEmailCc = array();
$arrEmailBcc = array();
