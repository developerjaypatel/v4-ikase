...
if (isset($_GET["gtok"])) {
	...
	//$url = "https://www.ikase.org/api/gmail/settoken";
	try {
		/*
...
if($blnMobile) {
	header("location:https://www.ikase.org/mobilev1.php");
}
...
<?php //die("here2"); ?>
   ...
   <?php 
	...
	var blnAdmin = false;
		...
		//subscription_bitly_link = '<?php //echo make_bitly_url("https://www.ikase.org/api/sync_calendar_kase.php?" . $_SESSION["subscription_string"]); ?>';
		<?php } ?>
	...
	?>
    <?php if ($_SESSION["user_customer_id"]==1033 || $_SESSION["user_customer_id"]==1116) { ?>
    ...
    <iframe id="check_gmail_messages" frameborder="0" width="10px" height="10px"></iframe>
    <!--
