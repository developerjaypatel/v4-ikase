  ...
  <script language="javascript">
	...
	*/
	...
	setTimeout(function() {
		...
		$("#password_holder").prepend('<div style="position:absolute; top:-27px; font-size:1.2em; width:20px; visibility:hidden; z-index: 9999;top: 17px;margin-left:-20px;" id="eye_holder"><i class="glyphicon glyphicon-eye-open" style="color:black; cursor:pointer" id="show_password" title="Show Password"></i></div>');
