...
<div class="container">
  <div style="background:url(../../img/translucent.png) repeat-y top left; padding-left:50px; padding-top:100px; height:100%">
    <div class="form-signin-heading" style="color:white; font-size:2.2em; padding-bottom:50px; font-weight:lighter; margin-left:-35px">
      <p><i class="glyphicon glyphicon-hourglass"></i>&nbsp;Payroll Master</p>
    ...
    <div style="width:210px">
      ...
      <div style="padding-top:30px" class="white_text"> <span style='font-size:1.6em'><?php echo date('h:i A'); ?></span><br />
        ...
        <div style="padding-top:30px">
          ...
          <div class="small_text" style="margin-top:100px">iKlock Version 0.1</div>
        </div>
      </div>
    </div>
  </div>
...
<script language="javascript">
var wallpaper_image = "images/astro.jpg";
var rand = Math.floor((Math.random() * 3) + 1);
console.log(rand);
if (rand > 1) {
	wallpaper_image = "images/oversized.jpg";
}
if (rand > 2) {
	wallpaper_image = "images/many.jpg";
}
/*
$("body").wallpaper({
...
<div id="quote_holder">
<img src="images/gifs/triangle_gif_black_bg.gif" width="600" height="484" />
