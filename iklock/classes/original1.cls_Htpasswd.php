...
//	Returns true on success, false on failure
	...
	function changePass ($UserID, $newPass, $oldPass = "")
	{
		...
		//echo "write" .  $this->USERS[$usernum]["pass"] . "<BR>";
		if(!($this->htWriteFile()))
		{
