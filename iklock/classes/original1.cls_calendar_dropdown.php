...
class Calendar
{
    ...
    */
    function getMonthHTML($m, $y, $showYear = 1)
    {
		...
		//drop down event
		//header drop down
		$header_months = '<select name="themonth" id="themonth" onchange="jumpDate()">
		...
		//select option
		$strip_month = date("n", strtotime("2000-" . $month . "-01"));
		$header_months = str_replace('"' . $strip_month . '"', '"' . $strip_month . '" selected', $header_months);
		$header_years = '<select name="theyear" id="theyear" onchange="jumpDate()">
		...
		$header_years = str_replace('"' . $year . '"', '"' . $year . '" selected', $header_years);
    	$header = $header_months . "&nbsp;" . $header_years;
		//"<BR>" . $monthName . (($showYear > 0) ? " " . $year : "");
