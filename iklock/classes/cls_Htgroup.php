...
//	**************************************************************
	function __construct($groupFile = "")
	{
		if(!empty($groupFile))
		{
...
//die("file: " . $filename);
			...
			for($count=0;$count<count($Mytemp);$count++)
			{
				...
				list ($group,$users) = explode(":",$Mytemp[$count]);
...
//	**************************************************************
	function getGroups ()
	{
		...
		$MyTemp = $this->GROUPS;
		foreach ($MyTemp as $GroupID => $users)
		{
...
//	**************************************************************
	function getUsersForGroup($GroupID)
	{
		...
		foreach ($MyTemp as $GroupName => $users)
		{
...
//	**************************************************************
	function addUserToGroup ($UserID,$GroupID)
	{
		...
		else
		{
			...
			foreach ($UserID as $key => $UserName)
			{
...
//	**************************************************************
	function htWriteFile ()
	{
		...
		foreach ($MyTemp as $GroupName => $UserNames)
		{
			if(!empty($GroupName))
			{
				fwrite($fd, "$GroupName:");
