...
$query = "";
if ($cus_id=="" || $cus_id==-1) {
	$query = "INSERT INTO cse_customer (`eams_no`, `cus_name`, `cus_name_first`, `cus_name_middle`, `cus_name_last`, `cus_street`, `cus_city`, `cus_county`, `cus_state`, `cus_zip`, `cus_email`, `cus_phone`, `cus_fax`, `cus_type`, `cus_ip`, `pwd`, `admin_client`,`data_source`,`data_path`,`permissions`,`inhouse_id`, `jetfile_id`, `ddl_venue`,`office_manager_first`, `office_manager_last`, `office_manager_middle`, `office_manager_phone`, `office_manager_email`, `cus_fedtax_id`, `cus_uan`, `cus_barnumber`, `user_rate`, `corporation_rate`, `start_date`)
	VALUES ('" . addslashes($eams_no) . "', '" . addslashes($cus_name) . "', '" . addslashes($cus_name_first) . "', '" . addslashes($cus_name_middle) . "', '" . addslashes($cus_name_last) . "', '" . addslashes($cus_street) . "', '" . addslashes($cus_city) . "', '" . addslashes($cus_county) . "', '" . addslashes($cus_state) . "', '" . addslashes($cus_zip) . "', '" . addslashes($cus_email) . "', '" . addslashes($cus_phone) . "', '" . addslashes($cus_fax) . "', '" . addslashes($cus_type) . "', '" . addslashes($cus_ip) . "', '" . addslashes($pwd) . "', '" . addslashes($admin_client) . "','" . $data_source . "','" . $data_path . "','" . $permissions . "','" . $inhouse_id . "','" . $jetfile_id . "', '" . $letter_office_code . "','" . addslashes($office_manager_first) . "','" . addslashes($office_manager_last) . "','" . addslashes($office_manager_middle) . "','" . addslashes($office_manager_phone) . "','" . addslashes($office_manager_email) . "','" . addslashes($cus_fedtax_id) . "','" . addslashes($cus_uan) . "','" . addslashes($cus_barnumber) . "','" . addslashes($user_rate) . "','" . addslashes($corporation_rate) . "', '" . date("Y-m-d") . "')";
...
if ($attorney_name_first!="") {
	//insert attorney
	$query = "INSERT INTO ikase.cse_attorney (`customer_id` customer_id, `firm_name`, `first_name`, `middle_initial`, `last_name`, `phone`, `fax`, `email`, `default_attorney`, `attorney_username`, `attorney_password`)
	...
	$result = mysql_query($query, $r_link) or die("unable to insert attorney");
}
//default for now
