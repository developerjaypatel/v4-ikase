...
<?php echo $cus_name; ?></strong>
    ...
    <p><a href="javascript:setFrame('../../api/import_abacus.php?customer_id=<?php echo $customer_id; ?>')">Cases</a>
    <br />
    MUST FIX INJURIES SECTION
	</p>
    <p><a href="javascript:setFrame('../../api/import_abacus_adj.php?customer_id=<?php echo $customer_id; ?>')">Missing Injuries</a></p>
    <p><a href="javascript:setFrame('../../api/import_abacus_orphans.php?customer_id=<?php echo $customer_id; ?>')">Orphan Orders</a></p>
    <p><a href="javascript:setFrame('../../api/import_abacus_notes.php?customer_id=<?php echo $customer_id; ?>')">Notes</a></p>    
    <p><a href="javascript:setFrame('../../api/import_abacus_docs.php?customer_id=<?php echo $customer_id; ?>')">Documents</a></p>    
