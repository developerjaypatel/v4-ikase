...
if (is_object($user)) {
	...
	$start_time = $user->day_start;
	$end_time = $user->day_end;
	if ($start_time == "") {
		$start_time = "08:00AM";
		$end_time = "05:00PM";
	}
...
foreach($jobs as $user_job) {
	...
	$job_uuid = $user_job->job_uuid;
	$the_job = $user_job->job;
	$selected = "";
	if ($job==$the_job) { 
		$selected = " selected"; 
	}
...
<input type="hidden" value="<?php echo $suid; ?>" name="suid" id="suid" />
    <table width="980" border="0" align="center" cellpadding="2" cellspacing="0">
      ...
      <tr>
        <td colspan="2" bgcolor="#CCCCCC"><div style="float:right"><a href="index.php?cus_id=<?php echo $cus_id; ?>"> Users</a></div>
