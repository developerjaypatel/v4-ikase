...
$result = DB::runOrDie("SELECT cus_name_first, cus_name_last, cus_name, cus_street, cus_city, cus_state, cus_zip FROM tbl_customer WHERE cus_id = ?", [$the_cus_id])->fetch();
?>
...
<div class="informations" style="width:40em; background:white; padding-left:5px">
    <div>
        ...
        <span id="customer"><?php echo $result['cus_name']; ?></span>
    </div>
    <div>
