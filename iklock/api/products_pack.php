...
$app->group('', function (RouteCollectorProxy $app) {
	$app->group('/products', function (RouteCollectorProxy $app) {
		$app->get('', 'getProducts');
		$app->get('/supplier/{supplier_id}/{product_id}', 'getSupplierProducts');
	});
	$app->group('/product', function (RouteCollectorProxy $app) {
		$app->get('/{product_id}', 'getProduct');
		$app->post('/add', 'addProduct');
		$app->post('/purchase/add/{purchase_id}', 'addPurchaseProduct');
		$app->post('/update', 'updateProduct');
		$app->post('/update/pending/{product_id}', 'updateProductPending');
		$app->post('/batch/join/{product_id}', 'addProductBatch');
	});
