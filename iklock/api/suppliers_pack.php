...
$app->group('', function (RouteCollectorProxy $app) {
	$app->get('/suppliers', 'getCorporations');
	$app->group('/supplier', function (RouteCollectorProxy $app) {
		$app->get('/{corporation_id}', 'getCorporation');
		//$app->get('/search/{query}', 'searchCorporation');
