<?php
//get
$app->get('/patients', authorize('user'), 'getPatients');
$app->get('/patient/:patient_id', authorize('user'), 'getPatient');

$app->get('/patients/search/:search_term', authorize('user'), 'searchPatients');

//posts
$app->post('/patient/add', authorize('user'), 'addPatient');
$app->post('/patient/update', authorize('user'), 'updatePatient');
