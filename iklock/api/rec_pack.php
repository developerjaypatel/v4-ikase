...
$app->group('', function (RouteCollectorProxy $app) {
	$app->group('/recs', function (RouteCollectorProxy $app) {
		$app->get('', 'getRecs');
		$app->get('/patient/{person_id}', 'getPatientRecs');
	});
	$app->group('/rec', function (\Slim\Routing\RouteCollectorProxy $app) {
		$app->get('/{person_id}', 'getRec');
		$app->post('/add', 'addRec');
		$app->post('/update', 'updateRec');
	});
