<?php
$app->post('/paycheck/save', authorize('user'), 'saveCheck');
$app->post('/paycheck/contractors/save', authorize('user'), 'saveContractorsChecks');

$app->post('/paycheck/delete', authorize('user'), 'deleteCheck');
