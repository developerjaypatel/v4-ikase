<?php
$app->group('/company', function (\Slim\Routing\RouteCollectorProxy $app) {
	$app->post('/general/save', 'saveCompanyGeneralTaxes');
	$app->post('/federal/save', 'saveCompanyFederalTaxes');
	$app->post('/state/save', 'saveCompanyStateTaxes');
	$app->post('/payschedule/save', 'saveCompanyPayschedule');
