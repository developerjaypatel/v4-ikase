...
<input id="billing_time" name="billing_time" type="hidden" value="" />
		...
		<table border="0" cellpadding="3" style="width:100%">
			...
			<tr>
			   ...
			   <td>
				  <input value="<%= exam_dateandtime %>" name="exam_dateandtimeInput" id="exam_dateandtimeInput" class="kase exam_view" placeholder="MM/DD/YYYY" style="width:389px" autocomplete="off" />
			   </td>
			</tr>
			<tr>
			   ...
			   <td>
				  <input value="<%= exam_status %>" name="exam_statusInput" id="exam_statusInput" class="kase exam_view" placeholder="Status" style="z-index:3259; width:389px" />
               </td>
			</tr>
			<tr>
			   <th align="left" valign="top">
			   ...
			   <td>
				  <input value="<%= exam_type %>" name="exam_typeInput" id="exam_typeInput" class="kase exam_view" placeholder="Type" style="width:389px" />
			   </td>
			</tr>
			<tr>
			   <th align="left" valign="top">
			   ...
			   <td>
				  <input value="<%= specialty %>" name="specialtyInput" id="specialtyInput" class="kase exam_view" placeholder="Specialty" style="width:389px" />
			   </td>
			</tr>
			<tr>
			   <th align="left" valign="top">
			   ...
			   <td>
				  <input value="<%= requestor %>" name="requestorInput" id="requestorInput" class="kase exam_view" placeholder="Requestor" style="width:389px" />
		       </td>
			</tr>
			<tr>
			   <th align="left" valign="top">
			...
			<tr>
			   ...
			   <td align="left" valign="top">
				  <input value="<%=fs_date %>" name="fs_dateInput" id="fs_dateInput" class="kase exam_view" placeholder="MM/DD/YYYY" style="width:389px" autocomplete="off" />
			   </td>
			</tr>
			<tr>
			   <th colspan="2" align="left" valign="top">
				  Records Type
				    <textarea name="commentsInput" id="commentsInput" class="kase exam_view" placeholder="Comments" style="width:389px"><%= comments %></textarea>
				</th>
			</tr>
            <% if (document_id!="") { %>
            <!--
