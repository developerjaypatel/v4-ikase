...
<div style="background:url(../img/glass_card_fade_14.png); padding:5px; border:0px solid white; width:480px; float:left" id="gridster_accident" class="gridster">
    	<form id="personal_injury_dogbite_form">
        <input id="table_name" name="table_name" type="hidden" value="personal_injury_dogbite" />
        ...
        <ul>
            <li id="dog_breedGrid" data-row="1" data-col="1" data-sizex="1" data-sizey="1" class="<?php echo $form_name; ?> accident_view gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            <h6><div class="form_label_vert" style="margin-top:10px;">Breed</div></h6>
            <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="dog_breedSave">
                
                <a class="save_field" style="margin-top:0px;" title="Click to save this field" id="dog_breedSaveLink">
                    <i class="glyphicon glyphicon-save"></i>
                </a>
            </div>
              <input value="" name="dog_breedInput" id="dog_breedInput" class="kase <?php echo $form_name; ?> accident_view input_class hidden" style="width:150px; margin-top:-25px; margin-left:45px" tabindex="0" />
              <span id="dog_breedSpan" class="<?php echo $form_name; ?> span_class form_span_vert" style="margin-top:-28px; margin-left:90px"></span>
            </li>
          <li id="dog_ageGrid" data-row="1" data-col="2" data-sizex="1" data-sizey="1" class="<?php echo $form_name; ?> accident gridster_border" style="background:url(img/glass.png) left top; border:#FFFFFF solid 1px ; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; padding:5px; font-family: 'Open Sans', sans-serif; color:#FFFFFF">
            <h6><div class="form_label_vert" style="margin-top:10px;">Age</div></h6>
            <div style="margin-top:-12px" class="save_holder hidden" id="dog_ageSave">
                <a class="save_field" style="margin-top:0px" title="Click to save this field" id="dog_ageSaveLink">
                    <i class="glyphicon glyphicon-save"></i>
                </a>
            </div>
              <input value="" name="dog_ageInput" id="dog_ageInput" class="<?php echo $form_name; ?> kase accident_view input_class hidden" placeholder="" style="margin-top:-25px; margin-left:45px; width:150px; border:1px solid red" autocomplete="off" tabindex="1" />
              <span id="dog_ageSpan" class="<?php echo $form_name; ?> span_class form_span_vert" style="margin-top:-25px; margin-left:60px"></span>
            </li>
        </ul>
        </form>
    </div>
<div id="personal_injury_dogbite_done"></div>
<script language="javascript">
$("#personal_injury_dogbite_done").trigger( "click" );
</script>
</div>
