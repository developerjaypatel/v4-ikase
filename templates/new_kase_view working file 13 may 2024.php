...
while ($row = $result_sub_sub->fetch()) {
    ...
    <div class="kase">
        ...
        <table width="500px" border="0" align="left" cellpadding="3" cellspacing="0" id="new_kase_field_table">
            ...
            <tr>
                ...
                <td valign="top">
                    <select name="case_typeInput" id="case_typeInput" class="kase input_class" style="width:510px" parsley-error-message="" required onchange="">
            ...
            <tr id="pi_representing_row" class="injury_fields">
                ...
                <td valign="top">
                    <select onchange="" name="representingInput" id="representingInput" class="kase input_class" style="width:510px" >
          ...
          <tr class="kase_fields case_sub_status">
            ...
            <td valign="top" id="sub_status_td">
                <select name="case_substatusInput" id="case_substatusInput" class="kase input_class wcab_only_stat" style="width:450px;">
          ...
          <tr class="kase_fields case_sub_sub_status">
            ...
            <td valign="top" id="sub_sub_status_td">
                <select name="case_subsubstatusInput" id="case_subsubstatusInput" class="kase input_class" style="width:450px;">
