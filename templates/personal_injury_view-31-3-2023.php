            ...
            <div style="float:right; border:0px solid red" id="defendant_car_information">
                ...
                <div style="background:url(../img/glass_card_fade_19.png); padding:5px; border:0px solid white; width:auto;	" id="gridster_accident" class="gridster">
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_damagesSave">
                      ...
                      <input type="number" value="" name="damagesInput" id="defendant_damagesInput" class="<?php echo $form_name; ?> kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_towingSave">
                      ...
                      <input type="number" value="" name="towingInput" id="defendant_towingInput" class="<?php echo $form_name; ?> kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_storageSave">
                      ...
                      <input type="number" value="" name="storageInput" id="defendant_storageInput" class="<?php echo $form_name; ?> kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
                    ...
                    <div style="margin-top:-12px" class="save_holder hidden" id="defendant_lossesSave">
                      ...
                      <input type="number" value="" name="lossesInput" id="defendant_lossesInput" class="<?php echo $form_name; ?> kase vehicle input_class hidden" placeholder="" style="margin-top:-25px; margin-left:85px; width:100px; border:0px solid red" autocomplete="off" tabindex="1" />
