            ...
            <div style="display:inline-block">
                <div style="border:0px solid green; text-align:left">
                    ...
                    <div class="white_text" style="display:inline-block; padding-left:5px">
                        ...
                        <%=this.model.get('case_number') %><% if (this.model.get("adj_number")!="") { %><span class='black_text'>&nbsp;|&nbsp;</span><%=this.model.get('adj_number') %><% } %><span class='black_text'>&nbsp;|&nbsp;</span><%=this.model.get('case_type') %>><span class='white_text'>&nbsp;/&nbsp;</span><%= kase.get("case_sub_type") %>
                <span class='black_text'>&nbsp;|&nbsp;</span>Case&nbsp;Date:&nbsp;<%=this.model.get('case_date') %><span class='black_text'>&nbsp;|&nbsp;</span>Claim&nbsp;#:&nbsp;<span id="claim_number_fill_in"></span><span class='black_text'>&nbsp;|&nbsp;</span>Claims&nbsp;:&nbsp;
                        <br />
