               ...
               <td style="font-size:1.17em">
                   ...
                   <script>
                    ...
                    //    console.log(priority_value);
                       ...
                       temp4=`<%=occurence.event_from %> -> <%=occurence.assignee %>`; 
                       if("<%=occurence.case_name %>"!=""){
                       temp3=`<%=occurence.case_name%><br>`; }else { temp3= ""; }
                       <% if(occurence.case_name == occurence.event_title){ %>
                            highlight_html_data =temp+"<br>"+temp0+""+temp1+"<hr>"+temp2+"<hr>"+temp4;
                       <% }else{ %>
                            highlight_html_data =temp+"<br>"+temp3+""+temp0+""+temp1+"<hr>"+temp2+"<hr>"+temp4;
                       <% } %>
...
<script type="text/javascript">
      ...
      $(document).on('click','button.fc-listMonth-button',function() {
          $('.fc-view-container').attr('style','visibility:hidden;opacity:0');
          $('#occurence_listing').removeClass('hide').attr('style','margin-top: -260px');
      });       
