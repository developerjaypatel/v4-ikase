...
$case_sub_type_options = "<option value=''>Select from List</option>";
$arrCaseSubTypes = array();


while ($row = $result_case_sub_type->fetch()) {
  $case_sub_type = $row->case_sub_type;
  //$case_subtype_option = "<option value='" . $case_sub_type . "'>" . $case_sub_type . "</option>";
  //$case_type_options .= "" . $case_subtype_option;
}
            ...
            <tr>
             ...
             <tr>            
                ...
                <select name="case_sub_type" id="case_sub_type" class="kase input_class" style="width:210px">
                    ...
                    <!--option value="PI" <?php //if($case_sub_type=="PI") echo "selected"; ?>>PI</option>
                    <option value="SSDI" <?php //if($case_sub_type=="SSDI") echo "selected"; ?>>SSDI</option>
                    <option value="WC" <?php //if($case_sub_type=="WC") echo "selected"; ?>>WC</option-->
