...
if (!$blnQuickType) {
	$option = '<option value="quick">Quick Note</option>';
	$arrOptions["notes"][] = $option;
}
...
<div style="margin-top:-10px; padding-bottom:5px">
	<input type="button" class="btn btn-xs" id="view_main" value="Note" style="display:none">
...
<div class="new_note">
    ...
    <td width="90%" colspan="2" valign="top" id="case_id_holder"><input name="case_fileInput" type="text" id="case_fileInput" size="30" class="modal_input" />
    <span id="case_idSpan" style="font-size:1.2em"></span></td>
  </tr>
  <tr style="display:none" id="doi_row">
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><input type="text" name="subjectInput" id="subjectInput" style="width:100%" parsley-error-message="" value="<%=subject%>" required /></td>
  </tr>
  <% } %>
  <tr>
    ...
    <td valign="top">
      ...
      <span class="modal_span" style="font-size:1.2em"><%= moment(dateandtime).format('MM/DD/YYYY h:mma') %></span>    
      </td>
    <td align="right" valign="top"><label style="width:70px; text-align:left; display:inline-block">Type:</label>
		<?php if ($blnGlauber) { ?>
        <select name="typeInput" id="typeInput" class="modal_input" parsley-error-message="" required style="margin-top:-2px; width:150px">
  ...
  <tr>
    ...
    <td width="46%" align="right" valign="top">
    	<div style="text-align:right; width:100%">
        	<% if (task_id > 0) { %>
            <label style="width:70px; display:inline-block; text-align:left">Task Date:&nbsp;</label><div id="callback_dateSpan" style="display:inline-block; text-align:left; width:152px"><%=callback_date %>&nbsp;<a id="open_task_<%=task_id %>_<%=case_id %>" class="white_text open_task" data-toggle="modal" data-target="#myModal4" data-backdrop="static" data-keyboard="false" title="Click to edit this Task" style="cursor:pointer; text-decoration:underline">edit</a></div>
      		<input type="hidden" name="callback_dateInput" id="callback_dateInput" value="<%=callback_date %>" style="width:150px" parsley-error-message="" placeholder="Task Date" />
            <% } else { %>
        	<span style="font-weight:bold">Add Task:&nbsp;</span>
      		<input type="text" name="callback_dateInput" id="callback_dateInput" value="<%=callback_date %>" style="width:150px" parsley-error-message="" placeholder="Task Date" />
            <% } %>
      </div>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td colspan="2" valign="top" align="right">
    	<button id="recording_button"><i class="fa fa-microphone"></i></button>
        <button id="writing_button" style="display:none"><i class="fa fa-file"></i></button>
    </td>
  </tr>
  <tr id="note_input_holder">
  ...
  <tr id="note_speech_holder">
    <th colspan="3" align="left" valign="top" scope="row">
        <div id="speech_result" style="width:550px; height:100px; display:none; background:white; color:black; border:1px solid #ccc"></div>
        <span id="speech_feedback"></span>
    </th>
  </tr>
  <tr>
  	<td colspan="3">
  ...
  <tr>
  	<td colspan="3">
    	<div style="font-style:italic; font-size:1em; color:white"><br />* Notes statused as Most Important will be displayed on top of the Notes List</div>
    </td>
  </tr>
</table>
</form>
