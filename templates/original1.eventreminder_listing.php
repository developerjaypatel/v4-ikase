<div id="reminder_title" style="background:white; padding:2px; text-align:center; margin:0px">
    ...
    <div style="font-size:1.6em; width:250px; margin-left:auto; margin-right:auto">EVENT REMINDER<% if (messages.length > 1) {%>S<% } %></div>
...
<div style="padding:3px;">
    <table id="eventreminder_listing" class="eventreminder_listing" border="0" cellpadding="0" cellspacing="0">
        <tbody>
       <% 
