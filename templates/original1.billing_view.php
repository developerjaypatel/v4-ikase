<form id="billing_form" parsley-validate>
    ...
    <input id="modal_type" name="modal_type" type="hidden" class="billing billing_form" value="Activity" />
	...
	<tr id="date_row">
        ...
        <td colspan="2" valign="top">
              <input value="" name="billing_dateInput" id="billing_dateInput" class="billing billing_form" placeholder="" style="width:300px" parsley-error-message="Req" required />
              <span style="margin-left:62px"><strong>Hours:</strong></span>&nbsp;&nbsp;<span>
	...
	<tr id="status_row">
		...
		<td>
        	<select name="statusInput" id="statusInput" class="billing billing_form" style="width:450px">
    ...
    <tr id="billing_rate_row">
		...
		<td>
        	<select name="billing_rateInput" id="billing_rateInput" class="billing billing_form" style="width:450px">
    ...
    <tr id="activity_code_row">
		...
		<td>
        	<select name="activity_codeInput" id="activity_codeInput" class="billing billing_form" style="width:450px">
    ...
    <tr id="timekeeper_row">
		...
		<td><input type="input" name="timekeeperInput" id="timekeeperInput" class="billing billing_form" value="" style="width:450px" />
        </td>
	</tr>
    <tr id="description_row">
		<th align="left" valign="top" scope="row">Description:</th>
		<td><textarea type="input" name="descriptionInput" id="descriptionInput" class="billing billing_form" value="" style="width:450px" rows="5"></textarea>
        </td>
	</tr>
</table>
</form>
<div id="billing_view_done"></div>
<script language="javascript">
$( "#billing_view_done" ).trigger( "click" );
</script>
