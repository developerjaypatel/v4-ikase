    ...
    <form id="email_form" parsley-validate>
        ...
        <ul>
            ...
            <h6><div class="form_label_vert" style="margin-top:10px;">Email Addr</div></h6>
              <input value="<%= email_name %>" name="email_nameInput" id="email_nameInput" class="kase email_view input_class hidden" placeholder="someone@somesite.com" style="margin-top:-26px; margin-left:100px; width:280px" />
              <input value="<%= email_address %>" name="email_addressInput" id="email_addressInput" class="kase input_class kase hidden" style="display:none" />
            ...
            <div style="float:right;font-size:0.8em; font-style:italic; margin-top:-26px">
              ...
              <input value="" id="email_pwdInput" name="email_pwdInput" class="kase email_view input_class hidden" placeholder="Password" style="margin-top:-26px; margin-left:100px; width:140px" type="password" />
            ...
            <select name="email_methodInput" id="email_methodInput" class="kase input_class kase hidden" style="margin-top:-26px; margin-left:60px; width:140px">
            ...
            var display_pending = ""; 
            if (emails_pending=="N") {
	            display_pending = "To Inbox"; 
            }
            if (emails_pending=="Y") {
	            display_pending = "To Pending"; 
            }
            %>
            <select name="emails_pendingInput" id="emails_pendingInput" class="kase input_class kase hidden" style="margin-top:-26px; margin-left:100px">
            	<option value="N" <% if (emails_pending=="N" || emails_pending=="") { %>selected<% } %>>To Inbox</option>
                <option value="Y" <% if (emails_pending=="Y") { %>selected<% } %>>To Pending</option>
            </select>
