        ...
        <form id="accident_form" parsley-validate>
            ...
            <ul>
                ...
                <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="client_speedSave">
                  ...
                  <input value="<%= client_speed %>" name="client_speedInput" id="client_speedInput" class="input_class hidden" style="width:70px; margin-top:-25px; margin-left:85px" tabindex="0" />
                  <span id="client_speedSpan" class="accident accident_view span_class form_span_vert" style="margin-top:-28px; margin-left:65px"><%= client_speed %></span>
                </li>
                ...
                <div style="margin-top:-12px" class="save_holder hidden" id="client_directionSave">
                  ...
                  <input value="<%= client_direction %>" name="client_directionInput" id="client_directionInput" class="kase accident_view input_class hidden" placeholder="Direction" style="margin-top:-25px; margin-left:60px; width:80px; border:1px solid red" parsley-error-message="Req" required autocomplete="off" tabindex="1" />
                  <span id="client_directionSpan" class="kase accident_view span_class form_span_vert" style="margin-top:-25px; margin-left:60px"><%= client_direction %></span>
                </li>
            ...
            <div style="margin-top:-12px" class="save_holder hidden" id="client_laneSave">
              ...
              <input value="<%= client_lane %>" name="client_laneInput" id="client_laneInput" class="kase accident_view input_class hidden" placeholder="Lane" style="margin-top:-25px; margin-left:30px; width:70px" tabindex="2" />
              <span id="client_laneSpan" class="kase person_view span_class form_span_vert" style="margin-top:-30px; margin-left:85px"><%= client_lane %></span>
            </li>
            ...
            <div style="float:right; margin-right:0px; margin-top:-23px" class="hidden" id="defendant_speedSave">
              ...
              <input value="<%= defendant_speed %>" name="defendant_speedInput" id="defendant_speedInput" class="input_class hidden" style="width:70px; margin-top:-25px; margin-left:85px" tabindex="0" />
            ...
            <div style="margin-top:-12px" class="save_holder hidden" id="defendant_directionSave">
              ...
              <input value="<%= defendant_direction %>" name="defendant_directionInput" id="defendant_directionInput" class="kase accident_view input_class hidden" placeholder="Direction" style="margin-top:-26px; margin-left:60px; width:80px; border:1px solid red" parsley-error-message="Req" required autocomplete="off" tabindex="1" />
              <span id="defendant_directionSpan" class="kase accident_view span_class form_span_vert" style="margin-top:-25px; margin-left:60px"><%= defendant_direction %></span>
            </li>
            ...
            <div style="margin-top:-12px" class="save_holder hidden" id="client_laneSave">
              ...
              <input value="<%= defendant_lane %>" name="defendant_laneInput" id="defendant_laneInput" class="kase accident_view input_class hidden" placeholder="Lane" style="margin-top:-25px; margin-left:30px; width:70px" tabindex="2" />
              <span id="defendant_laneSpan" class="kase accident_view span_class form_span_vert" style="margin-top:-30px; margin-left:85px"><%= client_lane %></span>
            </li>
            ...
            <input value="<%= accident_location %>" name="accident_locationInput" id="accident_locationInput" class="kase input_class hidden accident" style="margin-top:-26px; margin-left:85px; width:370px" />
			...
			<div style="border:0px solid green">
                    	<div style="border:0px solid blue; position:absolute; left:90px; top:30px; margin-top:10px"><input class="kase accident_view input_class hidden" id="street_accident" value="<%=street %>" style="border: 0px solid red; width:370px;" /></div>&nbsp;&nbsp;<br />
                        <div style="border:0px solid yellow; position:absolute; left:90px; width:370px; margin-left:-85px; margin-top:31px"><input value="<%= suite %>" name="suiteInput" id="suiteInput" class="kase accident_view input_class hidden" style="margin-top:-26px; margin-left:85px;border: 0px solid red; width:370px;" /></div><br />&nbsp;&nbsp;
                        <div style="border:0px solid purple; position:absolute; left:90px; width:200px; margin-top: 0px; margin-left:0px"><input class="kase accident_view input_class hidden" id="city_accident"style="width:100px; border: 0px solid red; " value="<%=city %>" /></div>&nbsp;<div style="border:0px solid pink; position:absolute; left:0px; top:0px; width:100px; margin-top:94px; margin-left:200px"><input class="kase accident_view input_class hidden"
              id="administrative_area_level_1_accident" style="width:30px;border: 0px solid red" value="<%=state %>" />&nbsp;&nbsp;<div style="border:0px solid orange; position:absolute; left:0px; top:0px; width:100px; margin-top:0px; margin-left:65px"><input class="kase accident_view input_class hidden" id="postal_code_accident" style="width:50px" value="<%=zip %>" />
              </div>
                    </div>
            </li>
            ...
            <h6><div class="form_label_vert" style="margin-top:10px;">Client Street</div></h6>
              ...
              <input value="<%= client_street %>" name="client_streetInput" id="client_streetInput" class="kase accident_view input_class hidden" placeholder="" style="margin-top:-26px; margin-left:85px; width:370px" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" />
              <span id="client_streetSpan" class="kase accident_view span_class form_span_vert" style="margin-top:-28px; margin-left:85px"><%= client_street %></span>
            </li>
            ...
            <h6><div class="form_label_vert" style="margin-top:10px;">Defendant Street</div></h6>
              ...
              <input value="<%= defendant_street %>" name="defendant_streetInput" id="defendant_streetInput" class="kase accident_view input_class hidden" placeholder="" style="margin-top:-26px; margin-left:85px; width:370px" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" />
              <span id="defendant_streetSpan" class="kase accident_view span_class form_span_vert" style="margin-top:-28px; margin-left:85px"><%= defendant_street %></span>
            </li>
            ...
            <h6><div class="form_label_vert" style="margin-top:10px;">Road Conditions</div></h6>
              ...
              <input value="<%= road_conditions %>" name="road_conditionsInput" id="road_conditionsInput" class="kase accident_view input_class hidden" placeholder="" style="margin-top:-26px; margin-left:85px; width:370px" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" />
              <span id="road_conditionsSpan" class="kase accident_view span_class form_span_vert" style="margin-top:-28px; margin-left:85px"><%= road_conditions %></span>
            </li>
            ...
            <h6><div class="form_label_vert" style="margin-top:10px;">Traffic Controls</div></h6>
              ...
              <input value="<%= traffic_controls %>" name="traffic_controlsInput" id="traffic_controlsInput" class="kase accident_view input_class hidden" placeholder="" style="margin-top:-26px; margin-left:85px; width:370px" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" />
              <span id="traffic_controlsSpan" class="kase accident_view span_class form_span_vert" style="margin-top:-28px; margin-left:85px"><%= traffic_controls %></span>
            </li>
            ...
            <h6><div class="form_label_vert" style="margin-top:10px;">Weather</div></h6>
              ...
              <input value="<%= accident_weather %>" name="accident_weatherInput" id="accident_weatherInput" class="kase accident_view input_class hidden" placeholder="" style="margin-top:-26px; margin-left:85px; width:370px" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" />
              <span id="accident_weatherSpan" class="kase accident_view span_class form_span_vert" style="margin-top:-28px; margin-left:85px"><%= accident_weather %></span>
            </li>
            ...
            <textarea name="accident_descriptionInput" id="accident_descriptionInput" style="margin-top:0px; margin-left:0px; width:455px" rows="4" class="kase input_class hidden"><%= accident_description %></textarea>
            <span id="work_emailSpan" class="kase accident_view span_class form_span_vert" style="margin-top:-28px; margin-left:85px">
            ...
            <textarea name="accident_descriptionInput" id="accident_descriptionInput" style="margin-top:0px; margin-left:0px; width:455px" rows="2" class="kase input_class hidden"><%= accident_description %></textarea>
            <span id="accident_descriptionSpan" class="kase accident_view span_class form_span_vert" style="margin-top:-28px; margin-left:85px">
            <%= accident_description %>
            </span>
            </li>
