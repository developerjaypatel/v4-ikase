<div class="white_text" style="color:black">
    ...
    &nbsp;
    <button class="btn btn-xs" id="new_kase_sub_status_button">New Status</button>
...
<div>
    ...
    <div id="new_kase_sub_status_holder" style="display:none">
    	<input type="text" required id="new_kase_sub_status" />&nbsp;<select name="caseTypeInput" id="caseTypeInput" required="">
            ...
            <option value="class_action">Class Action</option>
                      </select> <button class="btn btn-xs btn-success" id="save_kase_sub_status">Save</button>
    </div>
	<%=html %>
    </form>
</div>
