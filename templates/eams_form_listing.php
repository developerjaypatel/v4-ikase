        ...
        <% } %>
       	<tr class="form_data_row form_row_<%= eams.id %>">
            ...
            <td align="left">   
                ...
                <% } else { %>
                <i class="glyphicon glyphicon-edit" style="color:#333333" title="Can't edit as manage by admin">
                <% } %>
            </td>
            ...
            <td>
                ...
                <% } else { %>
                    Can't update as manage by admin
                <% } %>
            </td>
            <td>
                <% if (eams.customer_id != "-1") { %>
                ...
                <% } else { %>
                <i class="glyphicon glyphicon-trash" style="color:#333333;" title="Can't delete as manage by admin">&nbsp;</i>
                <% } %>
            </td>
        </tr>
        <% }); %>
