     ...
     <div style="background:url(img/glass_<%=glass %>.png) left top repeat-y; padding:5px; width:480px;-moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px;">
        ...
        <div class="gridster kai kase" id="gridster_kai" style="display:">
            <ul>
                ...
                <input value="<%=emergency %>" name="emergencyInput" id="emergencyInput" style="margin-top:-26px; margin-left:60px" class="kase kai input_class hidden" />
                ...
                <input value="<%=emergency_contact %>" name="emergency_contactInput" id="emergency_contactInput" style="margin-top:-26px; margin-left:60px" class="kase kai input_class hidden" onkeypress="mask(this, mphone);" onblur="mask(this, mphone);" />
