...
window.Router = Backbone.Router.extend({
	...
	kaseDetailsNoParties: function (id) {		
		readCookie();
		var self = this;
		if (id < 0) {
			//new kase
		...
		parties = new Parties([], { case_id: id, panel_title: "Dashboard" });
		parties.fetch({
