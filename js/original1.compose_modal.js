...
function composeMessage(object_id, jsonInvoice) {
	...
	*/
	...
	setTimeout(function() {
		...
		$("#token-input-message_ccInput").css("width", "251px"); 
		$("#token-input-message_ccInput").parent().css("width", "251px");
		$("#token-input-message_ccInput").parent().parent().css("width", "251px");
		
		$("#token-input-message_toInput").css("width", "251px"); 
		$("#token-input-message_toInput").parent().css("width", "251px");
		$("#token-input-message_toInput").parent().parent().css("width", "251px");
		
		$("#token-input-message_bccInput").css("width", "251px"); 
		$("#token-input-message_bccInput").parent().css("width", "251px");
		$("#token-input-message_bccInput").parent().parent().css("width", "251px");
...
function composeEditCaseStatus(status_level) {
	...
	statusfilters.fetch({
		success: function (data) {
			...
			$("#modal_save_holder").html('<a onclick="newKaseStatus()" style="cursor:pointer" class="white_text">New ' + status_indicator + 'Status</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="showHiddenKaseStatuses()" class="white_text" style="cursor:pointer">Show All</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a title="Save Statuses" class="status save" onClick="saveModal()" style="cursor:pointer"><i class="glyphicon glyphicon-saved" style="color:#00FF00; font-size:20px">&nbsp;</i></a>');
...
function composeSessionNotValid() {
	...
	$(".modal-dialog").css("width", "700px");
	$(".modal-dialog").css("background-image", "url('img/glass_dark.png')");
