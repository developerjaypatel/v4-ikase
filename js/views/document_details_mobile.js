...
window.document_view_mobile = Backbone.View.extend({
	render: function () {
	...
	events: {
		"click .document .save": "addDocument",
		"click #document_view_all_done_mobile": "doTimeouts",
	},
	doTimeouts: function (event) {
		...
		if (this.model.get("document_dateandtime") != "") {
			var event_dateandtime = moment(this.model.get("document_dateandtime")).format("MM/DD/YYYY hh:mma");
		}
	...
	addDocument: function (document) {
		var self = this;
		document.preventDefault(); // Don't let this button submit the form

		addForm(document, "document", "document");
		return;
	}
});