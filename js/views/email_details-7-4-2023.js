	...
	render: function () {
		...
		setTimeout(function(){ 
			...
			for(var i=0; i<= countArray; i++){
				...
				$('.emailTable').append('<tr><td>'+json[i].email_address+'</td><td class="email_status_'+json[i].email_id+'">'+bb+'</td><td><a href="#" class="editEmail" email_id="'+json[i].email_id+'">Edit</a></td></tr>');
			}
		}, 3000);
