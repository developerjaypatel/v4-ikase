		...
		$.ajax({
			...
			success:function (data) {
				if(data.error) {  // If there is an error, show the error messages
					...
					$("#password_panel").html("<div style='color:white; font-size:1.2em; text-align:center'>Your password has been reset</div><div style='padding-top:5px; text-align:center'><a href='https://"+ location.hostname +"/' style='color:white'>Login</a></div>");
				}
			}
		});
	},
