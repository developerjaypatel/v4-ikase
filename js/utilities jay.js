...
var documentPreview = function(event, filename, customer_id, thumbnail_folder, document_type, document_date, parent_document_uuid, document_name="") {
	...
	if (thumbnail_folder!="") {
		...
		if (document_type=="batchscan3") {
			...
			if (arrFileName.length > 1) {
				...
				arrFileName.pop();
				arrFileName.pop();
				// Jay Change 12-1-2021
				// filename = arrFileName.join("_") + "-" + first_page + ".png";
				filename = document_name + ".jpg";
...
var documentThumbnail = function(filename, customer_id, thumbnail_folder, case_id, document_type, document_date, parent_document_uuid, document_name="") {
	if (typeof thumbnail_folder == "undefined") {
		thumbnail_folder = "";
	}
