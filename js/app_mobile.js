...
/* solulab code start 11-4-2019*/
	...
	showSubscriptionLink: function() {
		var subscription_link = "<div class='white_text'>For Outlook/Google Calendar Sync, use this url:<br><br>https://"+ location.hostname +"/api/ikase_sync2.php?" + subscription_string + "</div>";
