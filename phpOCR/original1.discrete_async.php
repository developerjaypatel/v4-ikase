...
for($page=0; $page < $pages; $page++) {
	...
	$image_path = $_SERVER["DOCUMENT_ROOT"] . "\\uploads\\" . $customer_id . "\\imports\\" . $timestamp . "\\" . $uploaded . "_" . $page . ".png";
	$image_name = $uploaded . "_" . $page . ".png";
	//echo $image_name . " -> ";
	$filesize = filesize($image_path);
	
	//echo $image_path . " -> " . $filesize . "\r\n";
	if ($filesize < 1750) {
	//if ($filesize < 5300) {
		//get consideration
		...
		$params = array('page'=>$page,'pages'=>$pages,'batchscan_id'=>$batchscan_id,'image_path'=>$image_name,'customer_id'=>$customer_id,'uploaded'=>$uploaded, 'timestamp'=>$timestamp);
		$param = "page=" . $page . "&pages=" . $pages . "&batchscan_id=" . $batchscan_id . "&image_path=" . $image_name . "&customer_id=" . $customer_id . "&uploaded=" . $uploaded . "&timestamp=" . $timestamp;
