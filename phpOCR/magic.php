...
header("location:discrete_qr_sync.php?uploaded=" . $uploaded . "&customer_id=" . $customer_id . "&batchscan_id=" . $batchscan_id . "&pages=" . $pages . "&timestamp=" . $timestamp);
?>
