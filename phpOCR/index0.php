...
//btw if anyone has a good idea how to integrate other image formats please let me know
		...
		echo 'ERROR: GIF support is not in by default! If you really want to enable this check parse_image function in index0.php';
		exit(0);
	}
...
/**************************************************************************************************/
	...
	$ret.='<form enctype="multipart/form-data" action="index0.php" method="post">';
	$ret.='<tr><td colspan=2>';
	...
	$ret.='curl -s -o out1.txt http://YOUR_URL/index0.php?out=plain&filename=http://REMOTE_URL/image.png<br>';
	$ret.='or better just hack the index0.php :)';
	$ret.='</td></tr></table>';
	$ret.='</center>';
	$ret.='</body>';
	$ret.='</html>';
