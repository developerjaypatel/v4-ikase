...
$numbs = 0;
if ($user_id!="") {
	$query = "SELECT  `user_id`,`user_name`, `password`, `user_email`, `day_start`, `day_end`, `level`, `job`, `days_of_week`, `dow_times`,
...
if ($numbs>0) {
	...
	$days_of_week = mysql_result($result, $int, "days_of_week");
	$start_time = mysql_result($result, $int, "day_start");
	$end_time = mysql_result($result, $int, "day_end");
	if ($start_time == "") {
		$start_time = "08:00AM";
		$end_time = "05:00PM";
	}
	...
	$dow_times = mysql_result($result,$int,'dow_times');
	//echo "dt:" . $dow_times;
	$arrDOWTimes = explode("|", $dow_times);
	if (count($arrDOWTimes)==1) {
		$arrDOWTimes = array($start_time."-".$end_time,$start_time."-".$end_time,$start_time."-".$end_time,$start_time."-".$end_time,$start_time."-".$end_time,$start_time."-".$end_time);
	}
	...
	$user_first_name = mysql_result($result, $int, "user_first_name");
	$user_last_name = mysql_result($result, $int, "user_last_name");
...
<input type="hidden" value="<?php echo $suid; ?>" name="suid" id="suid" />
    <table width="980" border="0" align="center" cellpadding="2" cellspacing="0">
      <tr>
        <td colspan="2" bgcolor="#CCCCCC"><img src="../images/logo.png" alt="EAMS JetFile" width="174" height="26" /></td>
      </tr>
      <tr>
...
Email</td>
        <td width="113" align="left" valign="bottom" nowrap="nowrap"><select name="level" id="level" tabindex="3">
          ...
          <br />
Role </td>
        <td width="516" align="left" valign="bottom" nowrap="nowrap"><select name="job" id="job" tabindex="4">
...
Job</td>
      ...
      <tr>
        ...
        User Logon<br /></td>
        <td><input name="password" type="text" id="password" size="7" tabindex="7" />
        <br />
        Password</td>
      </tr>
      <tr>
