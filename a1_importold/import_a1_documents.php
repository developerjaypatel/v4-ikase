...
try {
	...
	$sql_truncate = "TRUNCATE `cse_document`; 
	TRUNCATE `cse_case_document`; ";
	...
	*/
	foreach($cases as $key=>$case){
		...
		$sql = "INSERT INTO `cse_case_document` (`case_document_uuid`, `case_uuid`, `document_uuid`, `attribute_1`, `last_updated_date`, `last_update_user`, `deleted`, `customer_id`)
		...
		$sql = "INSERT INTO `cse_document` (document_uuid, parent_document_uuid, document_name, document_date, type, `description`, `description_html`, customer_id) 
