...
$app->get('/forms', authorize('user'),	'getForms');
$app->get('/forms/:id', authorize('user'),	'getForm');

//posts
$app->post('/forms/delete', authorize('user'), 'deleteEAMSForm');
$app->post('/forms/add', authorize('user'), 'addEAMSForm');
$app->post('/forms/update', authorize('user'), 'updateEAMSForm');
