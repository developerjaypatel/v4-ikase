...
for($i=$tot;$i>0;$i--)
{
	...
	echo "<br><a onClick='readMessage(" . $i . ")'>Read</a><br>";
	echo "<br>*******************************************************************************************<BR>";
	echo "<div id='body_" . $i . "' style='display:none'>" . $obj->getBody($i) . "</div>";  // Get Body Of Mail number Return String Get Mail id in interger
