<?php
$app->get('/tasks', authorize('user'),	'getTasks');
$app->get('/tasksbydates/:start/:end', authorize('user'),	'getTasksByDates');
$app->get('/kasetasksbydates/:start/:end/:case_id', authorize('user'),	'getKaseTasksByDates');
$app->get('/tasksbydatescompleted/:start/:end', authorize('user'),	'getCompletedTasksByDates');

$app->get('/taskinbox', authorize('user'),	'getTaskInbox');
$app->get('/taskclosedinbox', authorize('user'), 'getTaskClosedInbox');
$app->get('/tasksuser/:user_id', authorize('user'), 'getUserTasks');
$app->get('/tasksuser/:user_id/:day', authorize('user'), 'getUserTasksByDate');
$app->get('/tasksuser/:user_id/:day/:end_day', authorize('user'), 'getUserTasksByDateRange');

$app->get('/taskcaseinbox/:case_id', authorize('user'),	'getTaskCaseInbox');
$app->get('/taskcaseinboxclosed/:case_id', authorize('user'),	'getTaskCaseInboxClosed');
$app->get('/taskcaseinboxdeleted/:case_id', authorize('user'),	'getTaskCaseInboxDeleted');
$app->get('/taskcasedayinbox/:case_id/:day', authorize('user'),	'getTaskCaseDayInbox');
$app->get('/tasksingledaycompletedall/:day', authorize('user'),	'getCompletedTasksAllUsers');
$app->get('/taskcompleted', authorize('user'),	'getCompletedTasks');

$app->get('/taskdayinbox/:day', authorize('user'),	'getTaskDayInbox');
$app->get('/taskdaycompleted/:day', authorize('user'),	'getTaskDayCompleted');

$app->get('/tasksingledayinboxall/:day', authorize('user'),	'getTaskSingleDayInboxAllUser');
$app->get('/tasksinledayinbox/:day', authorize('user'),	'getTaskSingleDayInbox');
$app->get('/taskweekinbox/:week/:year', authorize('user'),	'getTaskWeekInbox');
$app->get('/taskinboxnew', authorize('user'),	'newTaskInbox');
$app->get('/taskinboxcheck', authorize('user'),	'checkTaskInbox');
$app->get('/taskoutbox', authorize('user'),	'getTaskOutbox');
$app->get('/taskoutboxcount', authorize('user'),	'getTaskOutboxCount');
$app->get('/taskcaseoutbox/:case_id', authorize('user'),	'getTaskCaseOutbox');
$app->get('/taskdayoutbox/:day', authorize('user'),	'getTaskDayOutbox');
$app->get('/taskoutboxbydate/:start/:end', authorize('user'),	'getTaskOutboxByDate');
$app->get('/tasks/:task_id', authorize('user'),	'getTask');
$app->get('/taskhistory/:task_id', authorize('user'), 'getTaskHistory');
$app->get('/tasks/recent', authorize('user'), 'getRecentTasks');
$app->get('/tasksummary', authorize('user'), 'getTasksSummary');

//overdues
$app->get('/overduetasks', authorize('user'), 'getOverDueTasks');
$app->get('/overduefirmtasks', authorize('user'), 'getOverDueFirmTasks');
$app->get('/overdueusertasks/:nickname', authorize('user'), 'getOverDueUserTasks');
$app->get('/overduefirmtaskscount', authorize('user'), 'getOverDueFirmTasksCount');
$app->get('/overduetaskscount', authorize('user'), 'getOverDueTasksCount');
$app->get('/overduekasetasks/:case_id', authorize('user'), 'getOverDueKaseTasks');
$app->get('/overduekasetaskscount/:case_id', authorize('user'), 'getOverDueKaseTasksCount');

//posts
$app->post('/task/read', authorize('user'), 'readTask');
$app->post('/task/restore', authorize('user'), 'restoreTask');
$app->post('/task/delete', authorize('user'), 'deleteTask');
$app->post('/task/add', authorize('user'), 'addTask');
$app->post('/task/update', authorize('user'), 'updateTask');
$app->post('/task/close', authorize('user'), 'closeTask');
$app->post('/task/update/date', authorize('user'), 'updateTaskDate');

$app->post('/tasks/transfer', authorize('user'), 'transferTasks');

$app->get('/task_types', authorize('user'), 'getTaskTypes');
$app->post('/task_type/add', authorize('user'), 'saveTaskTypes');
$app->post('/task_type/update', authorize('user'), 'updateTaskTypes');
...
function getTasksByDates($start, $end, $blnCompleted = false, $case_id = -1) {
	...
	if ($case_id == -1) {
		...
		ON tsk.task_uuid = utask.task_uuid AND INSTR(tsk.assignee, '" . $_SESSION['user_nickname'] . "') > 0 AND utask.deleted = 'N'";
	}
	$sql .= "
...
function getCompletedTasks($day = "", $all_users = "n", $start = "", $end = "") {
	...
	if ($all_users=="n") {
		$sql .= " ORDER BY tsk.task_dateandtime DESC, tsk.task_id DESC LIMIT 200";
	} else {
		$sql .= " ORDER BY tsk.assignee ASC, tsk.task_dateandtime DESC, tsk.task_id DESC LIMIT 200";
	}
		...
		*/
		if ($case_id!="") {
			...
			if (!$blnFirm) {
				...
				$sql .= "
				AND INSTR(task.assignee, '" . $assignee . "') > 0
...
function addTask() {
	...
	try { 
		...
		$db = null;
		//track now
		$activity_id = trackTask("insert", $new_id);
...
function addTask() {
	...
	$request = Slim::getInstance()->request();
	$db = getConnection(); // Changes from SOLULAB, uncommented this line
	$arrFields = array();
	$arrSet = array();
	$table_name = "";
	$table_id = "";
