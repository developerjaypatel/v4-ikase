...
$app->get('/billing', authorize('user'),	'getBillings');
//$app->get('/personalinjury/:case_id', authorize('user'),	'getPersonalInjury');
$app->get('/billing/:case_id/:action_id/:action_type', authorize('user'),	'getBilling');

$app->post('/billing/add', authorize('user'), 'addFullBilling');
//$app->post('/personal_injury/update', authorize('user'), 'updatePersonalInjury');

$app->get('/medicalbilling/:id', authorize('user'),	'getMedicalBilling');
$app->get('/medicalbillings/:case_id', authorize('user'), 'getMedicalBillings');
$app->get('/medicalbillingsummary/:case_id', authorize('user'), 'getMedicalBillingsLossSummary');
$app->get('/medicalcorpsummary/:case_id', authorize('user'), 'getMedicalBillingsSummary');
$app->get('/medsum/:case_id', authorize('user'), 'getMedicalSummary');
$app->get('/corpbillings/:case_id/:corporation_id', authorize('user'), 'getCorpMedicalBillings');

$app->post('/medicalbilling/add', authorize('user'), 'saveMedicalBilling');
$app->post('/medicalbilling/update', authorize('user'), 'saveMedicalBilling');
$app->post('/medicalbilling/delete', authorize('user'), 'deleteMedicalBilling');

//deductions
$app->get('/deduction/:id', authorize('user'),	'getDeduction');
$app->get('/deductions/:case_id', authorize('user'), 'getDeductions');
$app->get('/deductionstotal/:case_id', authorize('user'), 'getTotalDeductions');

$app->post('/deduction/save', authorize('user'), 'saveDeduction');
$app->post('/deduction/delete', authorize('user'), 'deleteDeduction');

//adjustments
$app->get('/adjustment/:id', authorize('user'),	'getAdjustment');
$app->get('/account/adjustments/:account_id', authorize('user'), 'getAdjustments');
$app->get('/adjustmentstotal/:account_id', authorize('user'), 'getTotalAdjustments');
$app->get('/adjustmentbytype/:account_id/:type', authorize('user'), 'getAdjustmentsByType');

$app->post('/adjustment/save', authorize('user'), 'saveAdjustment');
$app->post('/adjustment/delete', authorize('user'), 'deleteAdjustment');


//kinvoices
$app->get('/kinvoice/:kinvoice_id', authorize('user'),	'getKInvoice');
$app->get('/kinvoiceitem/:kinvoiceitem_id', authorize('user'),	'getKInvoiceItemInfo');
$app->get('/kinvoiceitems/:kinvoice_id', authorize('user'),	'getKInvoiceItems');
$app->get('/kinvoicedoc/:document_id', authorize('user'),	'getKInvoiceByDocument');
$app->get('/kinvoicetemplates/:document_id', authorize('user'),	'getInvoiceTemplatesByDocument');
$app->get('/kinvoicetemplatelists', authorize('user'),	'getFirmInvoiceTemplates');

$app->get('/kinvoicecheck/:check_id', authorize('user'),	'getKInvoiceByCheck');
$app->get('/kinvoicecase/:case_id/:document_id', authorize('user'),	'getKaseKInvoicesByDocument');
$app->get('/firminvoicescount', authorize('user'),	'getOutstandingKInvoicesCount');
$app->get('/prebillinvoicescount', authorize('user'),	'getPreBillKInvoicesCount');
$app->get('/paidinvoicescount', authorize('user'),	'getPaidKInvoicesCount');
$app->get('/firminvoices/:account_type', authorize('user'),	'getFirmKInvoices');
$app->get('/kinvoices/:case_id', authorize('user'),	'getKaseKInvoices');
$app->get('/kasekinvoicescount/:case_id', authorize('user'), 'getKaseKInvoicesCount');

$app->post('/kinvoiceitem/add', authorize('user'), 'saveKInvoiceItem');
$app->post('/kinvoiceitem/update', authorize('user'), 'updateKInvoiceItem');
$app->post('/kinvoiceitem/delete', authorize('user'), 'deleteKInvoiceItem');

$app->post('/kinvoice/delete', authorize('user'), 'deleteKInvoice');
$app->post('/kinvoice/update', authorize('user'), 'updateKInvoice');
$app->post('/kinvoice/transfer', authorize('user'), 'transferKInvoice');
/*
$app->post('/account/update', authorize('user'), 'updateBankAccount');
*/
$app->get('/account/:account_id', authorize('user'),	'getBankAccount');
$app->get('/account/adjustments/:account_id', authorize('user'), 'getBankAccountAdjustments');
$app->get('/account/cases/:account_id', authorize('user'), 'getBankAccountKases');
$app->get('/account/case/:case_id', authorize('user'),	'getKaseAccount');
$app->get('/account/firmbalance/:account_type', authorize('user'),	'getFirmAccountBalance');
$app->get('/account/displaybalance/:account_id', authorize('user'),	'displayAccountBalance');
$app->get('/account/balance/:case_id/:account_type', authorize('user'),	'getKaseAccountBalance');
$app->get('/account/balanceall/:account_type', authorize('user'),	'getAllKasesAccountBalance');
$app->get('/account/bytype/:case_id/:account_type', authorize('user'),	'getKaseAccountByType');
$app->get('/accounts/:account_type', authorize('user'),	'getBankAccountsByType');
$app->get('/listaccounts', authorize('user'),	'getBankAccounts');
$app->get('/accountsno/:case_id/:account_type', authorize('user'),	'getKaseNoAttach');

$app->post('/account/add', authorize('user'), 'saveBankAccount');
$app->post('/account/starting', authorize('user'), 'setStartingAmount');
$app->post('/account/attach', authorize('user'), 'attachBankAccount');
$app->post('/account/detach', authorize('user'), 'detachBankAccount');
$app->post('/account/clear', authorize('user'), 'clearAttachBankAccount');
$app->post('/account/delete', authorize('user'), 'deleteBankAccount');
...
function saveBankAccount() {
	...
	$arrFields = array("account_type", "account_info");
	$arrSet = array("'" . $account_type . "'", "'" . $account_info . "'");
	//insert the parent record first
	if (!$blnUpdate) { 
		$table_uuid = uniqid("RD", false);
