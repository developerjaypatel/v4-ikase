<?php
$app->get('/notes/:id', authorize('user'),	'getKaseNote');
$app->get('/notes/kases/:case_id', authorize('user'), 'getKaseNotes');
$app->get('/notes/dash/:case_id', authorize('user'), 'getKaseNotesDash');
$app->get('/notes/reflag/:case_id', authorize('user'), 'getRedFlag');
$app->get('/notes/:type/:case_id', authorize('user'), 'getNotesByType');
$app->get('/injurynotes/:type/:case_id', authorize('user'),	'getInjuryNotesByType');

//posts
$app->post('/notes/delete', authorize('user'), 'deleteNote');
$app->post('/notes/add', authorize('user'), 'addNote');
$app->post('/notes/update', authorize('user'), 'updateNote');
$app->post('/notes/detach', authorize('user'), 'detachNote');
