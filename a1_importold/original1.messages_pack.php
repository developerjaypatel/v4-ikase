...
function addEmailMessage($arrMessage = "") {
	...
	if (count($arrMessage)==0) {
		if ($_SERVER['REMOTE_ADDR']!="173.58.194.150" && $_SERVER['REMOTE_ADDR']!="173.58.194.146" && $_SERVER['REMOTE_ADDR']!="173.58.194.148" && $_SERVER['REMOTE_ADDR']!="71.254.171.237" && $_SERVER['SERVER_NAME']!="www.ikase.org") {
			echo $_SERVER['REMOTE_ADDR'] . "\r\n";
			die("no go...");
		}
		//die(print_r($_POST));
