...
$app->get('/coas/:case_id/:new_legal_id', authorize('user'),	'getCOAs');

$app->get('/coa/:case_id/:coa_id', authorize('user'),	'getFullCOA');

$app->post('/coa/add', authorize('user'), 'addFullCOA');
