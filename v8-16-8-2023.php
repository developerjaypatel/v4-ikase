...
<style>
  ...
  <body>
   ...
   <?php 
	...
	?>
    <?php if ($_SESSION["user_customer_id"]==1033 || $_SESSION["user_customer_id"]==1116 || $_SESSION["user_customer_id"]==1107 || $_SESSION["user_customer_id"]==4625 || $_SESSION["user_customer_id"]==4724 || $_SESSION["user_customer_id"]==2054 || $_SESSION["user_customer_id"]==2320) { ?>
