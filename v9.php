...
\Api\Bootstrap::session(3*HOUR, false);
session_write_close();

if ($_SERVER["HTTPS"] == "off") {
	header("location:https://www.ikase.org".$_SERVER['REQUEST_URI']);
}
...
<html lang="en">
  <head>
    ...
    <link href="jquery-dialogextend-master/jquery-ui.css" rel="stylesheet" type="text/css" />
  ...
  <body>
      	...
      	<div style="vertical-align:top">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div id="content" class="col-md-12 kase_content" style="top:60px;"></div>
                </div>
            </div>
        </div>
        <div id="chat_holder">
    ...
    <div class='dialog_content' style="background:url(img/glass_edit_header_new_solid.png)"></div>
   ...
   <?php 
	...
	?>
    <!-- cache scripts -->
	<script src="jquery-dialogextend-master/jquery-1.11.1.js"></script>
    ...
    -->
    <script src="jquery-dialogextend-master/1.11.0_jquery-ui.js"></script>
  	<script type="text/javascript" src="jquery-dialogextend-master/jquery.dialogextend.js"></script>
    ...
    <script language="javascript" type="text/javascript">
		...
		//worker
		var arrUserOptions = [];
		arrUserOptions.push("<option value=''>Filter By Worker</option>");
		var arrAttorneyOptions = [];
		arrAttorneyOptions.push("<option value=''>Filter By Atty</option>");
		var arrUserNicks = [];
		var arrWorkers = [];
		var arrAttys = [];
		var arrUserAttys = [];
		...
		kases.forEach(function(element, index, array) { 
			...
			if (user_name!="Matrix Admin" && user_name!="") {
				if (arrUserNicks.indexOf(user_name) < 0) {
					...
					arrUserOptions.push("<option value='" + user_nickname + "'>" + user_name + "</option>");
				}
			}
