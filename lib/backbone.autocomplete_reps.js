var AutoCompleteItemRepsView = Backbone.View.extend({
    tagName: "li",
    template: '<a href="#" style=""><%= label %><br/><span class="autocomplete_sub"><%= address_phone %></span></a>',
...
var AutoCompleteRepsView = Backbone.View.extend({
    tagName: "ul",
    itemView: AutoCompleteItemRepsView,
    className: "autocomplete_reps",
    ...
    render: function () {
		...
		$(".Defense #company_nameGrid").after(this.$el);
        return this;
    },
