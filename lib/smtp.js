...
Email = {
    send: function(e, o, t, n, a, s, r, c) {
        ...
        void 0 == a.token ? (i += "&Host=" + a,
        i += "&Username=" + s,
        i += "&Password=" + r,
        i += "&Action=Send") : (i += "&SecureToken=" + a.token,
    ...
    sendWithAttachment: function(e, o, t, n, a, s, r, c, d) {
        ...
        void 0 == a.token ? (m += "&Host=" + a,
        m += "&Username=" + s,
        m += "&Password=" + r,
        m += "&Action=Send") : (m += "&SecureToken=" + a.token,
    ...
    createCORSRequest: function(e, o) {
        ...
        return "withCredentials"in t ? t.open(e, o, !0) : "undefined" != typeof XDomainRequest ? (t = new XDomainRequest).open(e, o) : t = null,
        t
    }
};
