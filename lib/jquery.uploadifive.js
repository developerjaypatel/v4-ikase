    ...
    var a = {
		...
		*/
                        ...
                        if($(".modal").hasClass("in") && $("#send_queue").length > 0) {
                            ...
                            var path = "uploads/" + customer_id + "/" + current_filename;
                ...
                d.uploadComplete = function(l, j, k) {
                    if (b.inArray("onUploadComplete", f.overrideEvents) < 0) {
                        ...
                        if (j.queueItem.parent().parent().hasClass("eams_form_attach_form")) {
                            ...
                            j.queueItem.find(".filename").html("<a href='uploads/" + customer_id + "/" + current_filename + "' target='_blank' title='Click to review imported document'>" + current_filename + "</a>");
                        }
