var AutoCompleteItemEAMSView = Backbone.View.extend({
    tagName: "li",
...
var AutoCompleteEAMSView = Backbone.View.extend({
    tagName: "ul",
    itemView: AutoCompleteItemEAMSView,
    ...
    render: function () {
		...
		$(".Carrier #company_nameGrid").after(this.$el);
        return this;
    },
