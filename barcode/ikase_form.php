...
<div style="color:white; font-family:arial; padding-top:10px">
	<div style="background:forestgreen; color:white; font-weight:bold; width:600px; margin-top:10px; margin-bottom:10px; padding:5px">
    	<p>The Batchscan process has been updated as of 05/31/2023.  If you have not done so already, please make sure to reload iKase without caching by typing <span style='color:blue'>Ctrl-F5</span> keys, or clicking this <a href="javascript:parent.location.reload(true);" title="Click to reload iKase and empty browser cache" style="color:blue">	reload</a> link.</p> 
