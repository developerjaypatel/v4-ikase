...
foreach($persons as $x=>$person) {
	...
	if ($attorney != "") {
		if (is_numeric($attorney)) {
			...
			$att = DB::runOrApiError($query_att, ['user_id' => $attorney])->fetchObject();
...
//$numbs_noemp = $result_noemp->rowCount();
...
<table width="900" border="0" align="center" cellpadding="3" cellspacing="0" style="margin-top:0px">
  ...
  <tr>
    <td>&nbsp;</td>
    <td colspan="3">
    	<strong>Phone: </strong><?php echo $customer->cus_phone; ?>&nbsp;|&nbsp;
        <strong>Fax: </strong><?php echo $customer->cus_fax; ?>
    </td>
  </tr>
  <tr valign="top">
    <td colspan="4"><hr /></td>
