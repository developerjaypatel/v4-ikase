...
include_once (__DIR__.'qrcode/decoder/Decoder.php');
...
include_once (__DIR__.'qrcode/detector/FinderPatternInfo.php');
include_once (__DIR__.'qrcode/detector/FinderPatternFinder.php');
include_once ('ResultPoint.php');
include_once (__DIR__.'qrcode/detector/FinderPattern.php');
include_once (__DIR__.'qrcode/detector/AlignmentPatternFinder.php');
include_once (__DIR__.'qrcode/detector/AlignmentPattern.php');
include_once (__DIR__.'qrcode/decoder/Version.php');
include_once (__DIR__.'qrcode/decoder/BitMatrixParser.php');
include_once (__DIR__.'qrcode/decoder/FormatInformation.php');
include_once (__DIR__.'qrcode/decoder/ErrorCorrectionLevel.php');
include_once (__DIR__.'qrcode/decoder/DataMask.php');
include_once (__DIR__.'qrcode/decoder/DataBlock.php');
include_once (__DIR__.'qrcode/decoder/DecodedBitStreamParser.php');
include_once (__DIR__.'qrcode/decoder/Mode.php');
