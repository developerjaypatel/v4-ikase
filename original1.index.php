  ...
  <body onLoad="getQuote()">
    ...
    <div class="jumbotron">
      <div class="container" id="main_container">
        ...
        <p><div style="font:Arial, Helvetica, sans-serif; background:#F00; color:#FFF; font-size:60px">This is a Test site only! Please only use <a href="https://ikase.org" style="background:white; text-decoration:underline">ikase.org</a></div></p>
