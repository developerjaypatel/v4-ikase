...
LIMIT 0,1";
$result = mysql_query($query, $r_link) or die("unable to GFT DOR ID<br />" . mysql_error() . "<br />" . $query);
...
LIMIT 0, 1";
$resultfiling = mysql_query($queryfiling, $r_link) or die("unable to get uploads<br />" . $querypath . "<br />" . mysql_error());
$numbsfiling = mysql_numrows($resultfiling);
