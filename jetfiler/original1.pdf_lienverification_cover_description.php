...
$filename = "lienverification_out.fdf";
$filename_output = "lienverification_" . $case_id . ".pdf";
...
if ($nopublish=="y") {
	...
	$source_pdf = $_SERVER['DOCUMENT_ROOT'] . "\\jetfiler\\pdf\\10770_5.pdf";
