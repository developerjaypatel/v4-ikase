...
$app->group('', function (RouteCollectorProxy $app) {
	$app->get('/getfee/{id}', 'getIndividualFee');
	$app->get('/settlement_fees/{settlement_id}/{case_type}', 'getSettlementFees');
	$app->get('/settlement_feecount/{settlement_id}', 'getSettlementFeeCount');
	$app->get('/wc_fees/{settlement_id}', 'getWCFees');
	$app->get('/wc_type_fees/{settlement_id}/{fee_type}', 'getWCFeesByType');
	$app->get('/referral_fee/{referral_id}', 'referralFee');

	$app->group('/fee', function (RouteCollectorProxy $app) {
		$app->get('/type/{injury_id}', 'getFee');
		$app->post('/add', 'addFee');
		$app->post('/delete', 'deleteFee');
		$app->post('/update', 'updateFee');
	});
	$app->group('/fees', function (RouteCollectorProxy $app) {
		$app->get('/{type}/{injury_id}', 'getFees');
		$app->post('/add', 'addFeesFromList');
	});

	$app->post('/costs/add', 'addCosts');
