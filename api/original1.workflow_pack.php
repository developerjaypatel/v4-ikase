<?php
$app->get('/workflows', authorize('user'),	'getWorkflows');
$app->get('/workflow/:workflow_id', authorize('user'),	'getWorkflow');
$app->get('/workflow/cases/:workflow_id', authorize('user'),	'getWorkflowKases');
$app->get('/workflow/triggers/:workflow_id', authorize('user'),	'getWorkflowTriggers');
$app->get('/workflownext', authorize('user'), 'getNextWorkflowID');
$app->get('/workflow/applied/:case_id', authorize('user'),	'getWorflowApplied');

$app->post('/workflow/activate', authorize('user'), 'activateWorkflow');
$app->post('/workflow/save', authorize('user'), 'saveWorkflow');

$app->post('/trigger/delete', authorize('user'), 'deleteTrigger');
$app->post('/trigger/save', authorize('user'), 'saveTrigger');
