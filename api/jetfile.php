...
$app->group('', function (RouteCollectorProxy $app) {
	$app->group('/jetfile', function (RouteCollectorProxy $app) {
		...
		$app->post('/save/app', 'saveApp');
		$app->post('/save/dor', 'saveDOR');
		$app->post('/save/dore', 'saveDORE');
		$app->post('/save/lien', 'saveLien');
		$app->post('/save/unstructured', 'saveUnstructured');

		$app->post('/check/applicant', 'checkApplicant');
		$app->post('/check/dor', 'checkDOR');
		$app->post('/check/dore', 'checkDORE');
