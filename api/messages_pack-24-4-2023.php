...
function addEmailMessage($arrMessage = "") {
	...
	*/
	...
	try {				
		...
		`snippet`, `dateandtime`, `from`, `message_to`, `attachments`, `status`, `customer_id`, `receiver`) ";
		$sql .= " VALUES(:messageId, 'email', :messageBody, :messageSubject, :messageSnippet, :messageDate, :messageSender, :message_to, :attachments, 'created', :customer_id, :receiver)";
