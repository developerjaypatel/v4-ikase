...
$app->group('', function (\Slim\Routing\RouteCollectorProxy $app) {
	$app->get('/negotiation/{id}', 'getNegotiation');
	$app->get('/negotiations/{case_id}', 'getNegotiations');
	$app->get('/negotiationsfirm/{case_id}/{corporation_id}', 'getNegotiationsbyFirm');

	$app->post('/negotiation/save', 'saveNegotiation');
	$app->post('/negotiation/delete', 'deleteNegotiation');
