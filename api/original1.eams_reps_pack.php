<?php
$app->get('/eams_rep', authorize('user'),	'getEamsReps');
$app->get('/eams_rep/:id', authorize('user'),	'getEamsRep');
$app->get('/eams_claimant/:id', authorize('user'),	'getEamsClaimant');
$app->get('/eams_repnumber/:eams_number', authorize('user'),	'getEamsRepByNumber');

$app->get('/eams/search/:search_term', authorize('user'), 'searchEAMSCompanies');

$app->get('/eams_reptoken', authorize('user'), 'getTokenRepEams');
$app->get('/eams_defense_token', authorize('user'), 'getTokenRepDefenseEams');

$app->get('/eams_claimanttoken', authorize('user'), 'getTokenClaimantEams');
$app->get('/eams_claimant_rep_token', authorize('user'), 'getTokenClaimantRepEams');
$app->get('/attorneys/tokeninput/:id', authorize('user'), 'getTokenEamsAttorney');

//OBSOLETE
$app->get('/defense/tokeninput/:id', authorize('user'), 'getTokenEamsAttorney');
