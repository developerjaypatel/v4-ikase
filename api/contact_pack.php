...
$app->group('', function (RouteCollectorProxy $app) {
	$app->group('/contact', function (RouteCollectorProxy $app) {
		$app->get('/cases/{id}', 'getContactCases');
		$app->post('/delete', 'deleteContact');
		$app->post('/add', 'addContact');
		$app->post('/update', 'updateContact');
	});

	$app->group('/contacts', function (RouteCollectorProxy $app) {
		$app->get('', 'getContacts');
		$app->get('/{id}', 'getContact');
	});
	$app->get('/contactsblocked', 'getBlockedContacts');
