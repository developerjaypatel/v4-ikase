...
$app->group('', function (RouteCollectorProxy $app) {
	$app->group('/exam', function (RouteCollectorProxy $app) {
		$app->get('/{exam_id}', 'getExam');
		$app->post('/delete', 'deleteExam');
	});

	$app->group('/exams', function (RouteCollectorProxy $app) {
		$app->get('/{case_id}', 'getExams');
		$app->post('/add', 'addExam');
		$app->post('/update', 'updateExam');
	});
