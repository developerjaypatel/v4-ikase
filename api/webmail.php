<?php
$app->group('/webmail', function (\Slim\Routing\RouteCollectorProxy $app) {
	$app->get('', 'getEmailInbox');
...
function getEmailInbox() {
	...
	for($i=$tot;$i>0;$i--)
	{
		$str=$obj->GetAttach($i,UPLOADS_PATH. $_SESSION['user_customer_id'] . "\\webmail_previews\\", $arrAcceptable);
