...
$app->group('', function (RouteCollectorProxy $app) {
	$app->group('/injury', function (RouteCollectorProxy $app) {
		$app->get('/{case_id}/{injury_id}', 'getInjury');
		$app->post('/delete', 'deleteInjury');
		$app->post('/add', 'addInjury');
		$app->post('/update', 'updateInjury');
		$app->post('/field/update', 'updateInjuryField');
	});
	$app->get('/injuryinfo/{case_id}/{injury_id}', 'getInjuryInfo');
	$app->get('/injury_kase/{case_id}', 'getKaseInjuries');
	$app->get('/occupation', 'searchOccupation');
...
function getKaseInjuries($case_id, $blnReturn = false) { //die("data injury");
	session_write_close();
