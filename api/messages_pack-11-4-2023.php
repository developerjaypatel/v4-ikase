...
function checkEmailMessage($customer_id = "", $user_id="", $messageId = "", $from = "") {
	...
	if ($customer_id=="") {
		...
		if ($_SERVER['REMOTE_ADDR']!="47.181.68.46" && $_SERVER['REMOTE_ADDR']!="173.58.194.146" && $_SERVER['REMOTE_ADDR']!="173.58.194.148" && $_SERVER['REMOTE_ADDR']!="71.254.171.237" && $_SERVER['SERVER_NAME']!="v2.ikase.org") {
