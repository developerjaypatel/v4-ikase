...
function generatePDF($form_name = "", $separator_title = "") {
	...
	//output
	$destination_folder = "D:/iKase.org/uploads/" . $_SESSION['user_customer_id'] . "/" . $case_id . "/eams_forms/";
	if (!is_dir($destination_folder)) {
		mkdir($destination_folder, 0755, true);
	}
	...
	$source_dir = $_SERVER['DOCUMENT_ROOT'] . '\\eams_forms\\';
	if($source_dir == "C:\\inetpub\\wwwroot\\ikase.org\\eams_forms\\")
	{
		$new_path = "D:\\ikase.org\\eams_forms\\";
		$source_dir = $new_path;
	}
	...
	if ($nopublish=="y") {
		...
		//exec('pdftk "C:\inetpub\wwwroot\ikase.org\eams_forms\4906H.pdf" fill_form "C:\inetpub\wwwroot\ikase.org\uploads\1033\182\eams_forms\4906H.fdf" output "C:\inetpub\wwwroot\ikase.org\uploads\1033\182\eams_forms\4906H.pdf"');
		
		//$command = "pdftk \"" . $source_dir . $form_name . ".pdf\" fill_form \"" . $filename . "\" output \"" . $pdftk_output . "\"";
		//echo $command;die;
	...
	if ($form_name=="app_cover") {
		...
		*/
		...
		$separator_find = "D:/iKase.org/uploads/" . $_SESSION["user_customer_id"] . "/" . $case_id . "/eams_forms/";
