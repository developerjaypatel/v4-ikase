...
$app->group('', function (RouteCollectorProxy $app) {
	$app->group('/calendar', function (RouteCollectorProxy $app) {
		$app->get('', 'getCalendars');
		$app->get('/{calendar_id}', 'getTheCalendar');
		$app->post('/delete', 'deleteForm');
		$app->post('/add', 'addCalendar');
		$app->post('/update', 'updateCalendar');
		$app->post('/assign', 'assignCalendar');
		$app->post('/unassign', 'unassignCalendar');
	});
	$app->get('/calendar_order/{sort_order}', 'getCalendarBySortOrder');
	$app->get('/personalcalendars', 'getPersonalCalendars');
	$app->get('/ics', 'getICSCalendar');

	$app->group('/blocked', function (RouteCollectorProxy $app) {
		$app->get('/{blocked_id}', 'getBlock');
		$app->post('/add', 'addBlock');
		$app->post('/delete', 'deleteBlock');
	});
	$app->get('/blockeddate/{start_date}', 'getBlocks');
	$app->get('/blockeddates/{start_date}/{end_date}', 'getBlockDates');
	$app->get('/blockedactive', 'getActiveBlocks');
...
function getCalendars() {
	...
	//die($sql);
	try {
		$customers_calendar = DB::select($sql);
