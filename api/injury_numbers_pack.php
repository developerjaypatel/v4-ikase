<?php
$app->group('/injury_number', function (\Slim\Routing\RouteCollectorProxy $app) {
	$app->get('/{case_id}/{injury_id}', 'getInjuryNumber');
	$app->post('/delete', 'deleteInjuryNumber');
	$app->post('/add', 'addInjuryNumber');
	$app->post('/update', 'updateInjuryNumber');
