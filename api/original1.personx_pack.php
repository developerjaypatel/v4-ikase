...
$app->get('/personx', authorize('user'),	'getPersonXs');
$app->get('/personemailx', authorize('user'),	'getPersonXEmails');
$app->get('/personx/tokeninput', authorize('user'),	'getTokenPersonXs');
$app->get('/personx/:id', authorize('user'),	'getPersonX');

//posts
$app->post('/personx/delete', authorize('user'), 'deletePersonX');
$app->post('/personx/add', authorize('user'), 'addPersonX');
$app->post('/personx/update', authorize('user'), 'updatePersonX');
