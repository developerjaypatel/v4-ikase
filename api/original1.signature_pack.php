<?php
$app->get('/signature/:user_id', authorize('user'), 'getSignature');
$app->post('/signature/add', authorize('user'), 'addSignature');
$app->post('/signature/update', authorize('user'), 'updateSignature');
