...
$app->group('', function (RouteCollectorProxy $app) {
	$app->group('/checks', function (RouteCollectorProxy $app) {
		$app->get('/kases/{case_id}', 'getChecks');
		$app->get('/kinvoice/{kinvoice_id}', 'getKinvoiceChecks');
		$app->get('/account/{account_id}', 'getAccountChecks');
		$app->get('/accountbyledger/{account_id}/{ledger}', 'getAccountChecksByLedger');
		$app->get('/kaseaccount/{case_id}/{account_id}', 'getKaseAccountChecks');
		$app->get('/in/{case_id}', 'getPayments');
		$app->get('/out/{case_id}', 'getDisbursments');
		$app->get('/settlement/{case_id}/{recipient}', 'getSettlementChecks');
		$app->get('/fee/{fee_id}', 'getFeeChecks');
		$app->get('/printed', 'getPrinteds');
		$app->get('/unprinted', 'getUnprinteds');
		$app->get('/cleared', 'getCleareds');
		$app->get('/uncleared', 'getUncleareds');
		$app->get('/clearedbyledger/{ledger}/{account_id}', 'getClearedsByLedger');
		$app->get('/unclearedbyledger/{ledger}/{account_id}', 'getUnclearedsByLedger');

		$app->get('/clearedtotals', 'getLedgerTotals');
		$app->get('/unclearedtotals', 'getUnclearedLedgerTotals');

		$app->get('/categories', 'getCheckCategories');

		$app->get('/{id}', 'getCheck');
	});

	$app->group('/check', function (RouteCollectorProxy $app) {
		$app->post('/add', 'addCheck');
		$app->post('/update', 'updateCheck');
		$app->post('/delete', 'deleteCheck');
		$app->post('/void', 'voidCheck');
		$app->post('/clear', 'clearCheck');
		$app->post('/unclear', 'unclearCheck');
	});
	$app->get('/checkbycase/{id}/{case_id}', 'getCheckByCase');
	$app->post('/printcheck', 'printCheck');

	$app->group('/cost_type', function (RouteCollectorProxy $app) {
		$app->post('/add', 'saveCostTypes');
		$app->post('/update', 'updateCostTypes');
	});

	$app->group('/checkrequest', function (RouteCollectorProxy $app) {
		$app->get('/{id}', 'getCheckRequest');
		$app->post('/update', 'updateCheckRequest');
		$app->post('/add', 'addCheckRequest');
		$app->post('/approve', 'approveCheckRequest');
		$app->post('/reject', 'rejectCheckRequest');
		$app->post('/void', 'voidCheckRequest');
		$app->post('/delete', 'deleteCheckRequest');
		$app->post('/detach', 'detachCheckRequest');
	});

	$app->group('/checkrequests', function (RouteCollectorProxy $app) {
		$app->get('', 'getCheckRequests');
		$app->get('/mine/{approval}', 'getMyCheckRequests');
		$app->get('/approved', 'getApprovedCheckRequests');
		$app->get('/denied', 'getRejectedCheckRequests');
		$app->get('/kases/{case_id}', 'getKaseCheckRequests');
		$app->get('/all', 'getAllCheckRequests');
		$app->get('/categories', 'getCheckRequestCategories');
	});

	$app->group('/checkrequest_type', function (RouteCollectorProxy $app) {
		$app->post('/add', 'saveCheckRequestTypes');
		$app->post('/update', 'updateCheckRequestTypes');
	});

	$app->get('/account/clearedtotals/{account_id}', 'getAccountLedgerTotals');
	$app->get('/account/unclearedtotals/{account_id}', 'getAccountUnclearedLedgerTotals');
	$app->get('/accountrequests/{account}/{approved}', 'getCheckRequestsByAccount');
