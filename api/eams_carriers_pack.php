...
$app->group('', function (\Slim\Routing\RouteCollectorProxy $app) {
	$app->get('/eams_carrier', 'getEamsCarriers');
	$app->get('/eams_carrier/{id}', 'getEamsCarrier');
	$app->get('/eams_token', 'getTokenEams');
	$app->get('/examiners/tokeninput/{id}', 'getTokenEamsEmployees');
