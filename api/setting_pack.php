...
$app->group('', function (\Slim\Routing\RouteCollectorProxy $app) {
	$app->group('/setting', function (\Slim\Routing\RouteCollectorProxy $app) {
		$app->get('/firm/{level}', 'getCustomerSettings');
		$app->get('/customer/{setting_id}', 'getTheCustomerSetting');
		$app->get('/getname/{name}', 'getTheCustomerSettingByName');
		$app->get('/user', 'getUserSettings');
		$app->get('/user/{user_setting_id}', 'getTheUserSetting');
		$app->post('/byname', 'postTheCustomerSettingByName');
		$app->post('/user/add', 'addUserSetting');
		$app->post('/user/update', 'updateSetting');
		$app->post('/delete', 'deleteSetting');
		$app->post('/customer/add', 'addCustomerSetting');
		$app->post('/customer/update', 'updateSetting');
	});
	$app->get('/settings/fresh', 'refreshCustomerSettings');

	//$app->get('/setting/customer/{category}/{case_id}', 'getCustomerSettingByCategory');
	$app->get('/documentfilters', 'getDocumentFilters');
	...
	$app->post('/substatusfilter/add', 'saveSubStatusFilters');
	$app->post('/subsubstatusfilter/add', 'saveSubSubStatusFilters');
	$app->post('/subsubstatusfilter/update', 'updateSubSubStatusFilters');
