<?php
$app->group('/lien', function (\Slim\Routing\RouteCollectorProxy $app) {
	//$app->get('/{id}', 'getLien');
	$app->get('/{injury_id}', 'getLiens');

	//$app->post('/delete', 'deleteLien');
	$app->post('/add', 'addLien');
	$app->post('/update', 'updateLien');
