...
if (isset($_GET["download"])) {
	if ($extension=="pdf" || $extension=="docx" || $extension=="wav") {
		die("<span style='background:green; color:white; padding:2px'>" . $path . " was found in our system
...
$iframe = "";
if (!$path) {
	die("<span style='background:red; color:white; padding:2px'>" . $file . " was not found in our system
...
echo 'document_id-' . $document_id.' \n ';
	...
	if (strpos($path, ".pdf") !== false || strpos($path, ".png") !== false || strpos($path, ".wma") !== false || strpos($path, ".wma") !== false || strpos($path, ".mp3") !== false || strpos($path, ".jpg") !== false) {
