...
$app->get('/person', authorize('user'),	'getPersons');
$app->get('/personemail', authorize('user'),	'getPersonEmails');
$app->get('/person/tokeninput', authorize('user'),	'getTokenPersons');
$app->get('/person/:id', authorize('user'),	'getPerson');
$app->get('/workhistory/:case_id', authorize('user'), 'workHistory');
$app->get('/clientemails', authorize('user'), 'getClientDOBEmails');
$app->get('/clientemailsbymonth/:month', authorize('user'), 'getClientDOBEmailsByMonth');

//posts
$app->post('/person/delete', authorize('user'), 'deletePerson');
$app->post('/person/add', authorize('user'), 'addPerson');
$app->post('/person/update', authorize('user'), 'updatePerson');
$app->post('/workhistory/add', authorize('user'), 'addFullWorkHistory');

$app->post('/person/field/update', authorize('user'), 'updatePersonField');
