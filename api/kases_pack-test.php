...
$app->group('', function (RouteCollectorProxy $app) {
	$app->get('/inactive/{days}', 'getInactives');

	$app->get('/kases', 'getKases');
	$app->get('/sess', 'getSess');
	$app->get('/openkases', 'getOpenKases');
	$app->get('/opensomekases/{start}', 'getOpenKasesLimited');
	$app->get('/currentkases/{kases}', 'setCurrentKasesCount');
	$app->get('/nextkases', 'getNextKases');
	$app->get('/previouskases', 'getPreviousKases');
	$app->get('/closedkases', 'getClosedKases');
	$app->get('/notaskskases', 'getNoTasksKases');
	$app->get('/noworkerkases', 'getNoWorkerKases');

	$app->get('/allkases', 'getAllKases');
	$app->get('/pikases', 'getPIKases');
	$app->get('/wkases', 'getWCKases');
	$app->get('/emailkases', 'getEmailKases');
	$app->post('/examinerkases', 'getExaminerKases');
	$app->get('/emailcsvkases', 'csvEmailKases');

	$app->group('/kases', function (RouteCollectorProxy $app) {
		$app->get('/tokeninput', 'getTokenInputKases');
		$app->get('/last', 'runLastQuery');
		$app->get('/lastmonth', 'runLastQueryMonths');
		$app->get('/lookup', 'lookupKases');
		$app->get('/recent', 'getRecentKases');
		$app->get('/billables', 'getKasesBillable');
		$app->get('/billablescount', 'getKasesBillableCount');

		$app->get('/report', 'getKasesReport');
		$app->get('/bymonth', 'getKasesReportByMonth');

		$app->get('/listbymonth/{year}/{month}', 'getKasesListByMonth');
		$app->get('/referralsbymonth/{start}/{end}/{referring}', 'getReferredKasesListByMonth');
		$app->get('/clientsbymonth/{start}/{end}/{client}', 'getClientKasesListByMonth');
		$app->get('/{id}', 'getKase');

		$app->get('/search/{search_term}', 'searchKases');
		$app->post('/byids', 'getKasesByIDs');

		$app->get('/mine/{search_term}/{modifier}', 'searchMine');
		$app->get('/rolodex/{search_term}/{modifier}', 'searchRelatedRolodex');

		$app->get('/claim/{id}', 'getKaseSSNClaim');
		$app->get('/related/{id}', 'getRelatedKases');
		$app->get('/employee/{name}/{partie_type}', 'getEmployeeKases');

		$app->get('/filelocation/{case_id}', 'getFileLocationInfo');

		$app->get('/matrixadj/{id}/{adj_number}', 'findMatrixOrderADJ');
		$app->get('/matrixorder/{id}', 'findMatrixOrder');
		$app->get('/matrixorderinfo/{case_id}', 'getLinkedMatrixOrder');

		$app->post('/matrix', 'getMatrix');
		$app->get('/matrixsent/{case_id}', 'getMatrixActivitySent');
		$app->post('/matrixlocation', 'getMatrixLocation');
		$app->get('/matrixlinkinfo/{id}/{case_id}', 'getLinkedMatrixOrderInfo');
		$app->get('/matrixsearch/{applicant}', 'searchMatrixOrder');
		$app->post('/matrixlink', 'linkMatrixOrder');
		$app->post('/matrixrequestlocation', 'getRequestLocation');
		$app->post('/matrixsyslocation', 'getMatrixLocationByReq');
		$app->post('/addon', 'addMatrixLocation');

		$app->get('/getall/{user_id}/{job}', 'getEmployeeKaseCountByJob');
		$app->post('/clearall', 'deleteAttorneyKases');

		$app->post('/filters', 'filterKases');
		$app->post('/transfer', 'transferKases');
		$app->post('/assign/worker', 'assignWorker');
	});
	$app->get('/referrals/bymonth', 'getReferralsReportByMonth');
	$app->get('/clients/bymonth', 'getClientsReportByMonth');

	$app->get('/kaseinfo/{id}', 'getKaseInfo');
	$app->get('/intakes', 'getIntakeKases');
	$app->get('/intakesfiltered/{filter}/{type}', 'getFilteredIntakeKases');
	$app->get('/intakesbyletter/{filter}/{type}/{letter}', 'getIntakeKasesByLetter');

	$app->get('/kases_workersummary', 'kaseWorkerSummary');
	$app->get('/kases_worker/{user_id}', 'workerKases');
	$app->post('/kases_worker_status', 'workerKasesByStatus');
	$app->post('/kases_worker_type', 'workerKasesByType');
	$app->get('/kases_workload/{user_id}', 'employeeWorkload');

	$app->get('/unattendedcount', 'getUnattendedCount');
	$app->get('/unattendeds', 'getUnattendedKases');
	$app->get('/unattendedcountall', 'getUnattendedCountAll');
	$app->get('/unattendedsall', 'getUnattendedKasesAll');

	$app->get('/inactivecount', 'getInactiveCount');
	$app->get('/inactives', 'getInactiveKases');

	$app->get('/inactivecount/wcab', 'getInactiveWCABCount');
	$app->get('/inactivesuboutcount/wcab', 'getInactiveWCABSuboutCount');
	$app->get('/inactives/wcab', 'getInactiveWCABKases');
	$app->get('/inactivesub/wcab', 'getInactiveWCABSubOutKases');

	$app->get('/inactivecount/pi', 'getInactivePICount');
	$app->get('/inactives/pi', 'getInactivePIKases');
	$app->get('/casecountbyletter', 'getCaseCountByLastNameLetter');
	$app->get('/casecountbyletter/{letter}', 'getCaseIDsbyLastNameLetter');

	$app->group('/kase', function (RouteCollectorProxy $app) {
		$app->post('/view', 'viewKase');
		$app->post('/no_note', 'leaveKase');
		$app->post('/add', 'addKase');
		$app->post('/addintake', 'addIntake');
		$app->post('/accept', 'acceptKase');
		$app->post('/reject', 'rejectKase');
		$app->post('/advancesearch', 'searchAdvanceKase');
		$app->post('/delete', 'deleteKase');
		$app->post('/update', 'updateKase');
		$app->post('/field/update', 'updateKaseField');
		$app->post('/rename', 'renameKase');
		$app->post('/claim', 'saveSSNClaim');
		$app->post('/filelocation', 'fileLocation');
		$app->post('/relate', 'relateKase');
		$app->post('/unrelate', 'unrelateKase');
	});

//JetFile integration
	$app->post('/kase/jetfile', 'jetfileKase');
...
function writeQuery($sql) {
	...
	$session_save_path = ROOT_PATH.'sessions'.DC;
...
function updateKase() {
	...
	$case_date = date("Y-m-d", strtotime($_POST["case_date"]));
	$terminated_date = passed_var("terminated_date", "post");
	if ($terminated_date!="" && $terminated_date!="00/00/0000") {
		$terminated_date = date("Y-m-d", strtotime($terminated_date));
	} else {
		$terminated_date = "0000-00-00";
	}
...
function kaseWorkerSummary() {
	...
	FROM (
		...
		ON ccase.worker = usr_byid.user_id AND usr_byid.deleted = 'N' AND usr_byid.activated = 'Y'
		
		LEFT OUTER JOIN ikase.cse_user usr_nick
		ON ccase.worker = usr_nick.nickname AND usr_nick.customer_id = :customer_id AND usr_nick.deleted = 'N' AND usr_nick.activated = 'Y'
		...
		LEFT OUTER JOIN ikase.cse_user usr_byid
		ON ccase.attorney = usr_byid.user_id AND usr_byid.deleted = 'N' AND usr_byid.activated = 'Y' AND ccase.worker != usr_byid.user_id
		
		LEFT OUTER JOIN ikase.cse_user usr_nick
		ON ccase.attorney = usr_nick.nickname AND usr_nick.customer_id = :customer_id AND usr_nick.deleted = 'N' AND usr_nick.activated = 'Y' AND ccase.worker != usr_nick.nickname
		...
		LEFT OUTER JOIN ikase.cse_user usr_byid
		ON ccase.supervising_attorney = usr_byid.user_id AND usr_byid.deleted = 'N' AND usr_byid.activated = 'Y' AND ccase.worker != usr_byid.user_id AND ccase.attorney != usr_byid.user_id
		
		LEFT OUTER JOIN ikase.cse_user usr_nick
		ON ccase.supervising_attorney = usr_nick.nickname AND usr_nick.customer_id = :customer_id AND usr_nick.deleted = 'N' AND usr_nick.activated = 'Y' AND ccase.worker != usr_nick.nickname AND ccase.attorney != usr_nick.nickname
		
		WHERE 1
		AND ccase.supervising_attorney != '' AND ccase.deleted = 'N'
		AND ccase.case_status NOT LIKE '%close%' AND ccase.case_status NOT LIKE 'CL-%' AND ccase.case_status NOT LIKE 'CLOSED%' AND ccase.case_status != 'DROPPED' AND ccase.case_status != 'REJECTED'
		AND ccase.customer_id = :customer_id
		GROUP BY IF(usr_byid.user_name IS NULL, IFNULL(usr_nick.user_name, ''), usr_byid.user_name)
	) case_workers
