<?php
$app->group('/personalinjury', function (\Slim\Routing\RouteCollectorProxy $app) {
	$app->get('', 'getPersonalInjuries');
	//$app->get('/{case_id}', 'getPersonalInjury');
	$app->get('/{case_id}', 'getFullPersonalInjury');
	$app->post('/add', 'addFullPersonalInjury');
	$app->post('/addrental', 'addRental');
	$app->post('/addrepair', 'addRepair');
	//$app->post('_injury/update', 'updatePersonalInjury');
	$app->post('/field/update', 'updatePersonalInjuryField');
