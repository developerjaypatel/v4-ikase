...
$app->get('/chat/:chat_id', authorize('user'),	'getChat');
$app->get('/chatlatest', authorize('user'),	'latestChatRequest');
$app->get('/chatread/:thread_id', authorize('user'),	'getChatbox');
$app->get('/chatnew', authorize('user'),	'checkChatbox');

//posts
$app->post('/chat/add', authorize('user'), 'addChat');
$app->post('/chat/save', authorize('user'), 'saveChat');
$app->post('/chat/read', authorize('user'), 'readChat');
$app->post('/chat/delete', authorize('user'), 'deleteChat');
$app->post('/thread/delete', authorize('user'), 'deleteThread');

$app->post('/chat/create', authorize('user'), 'createChat');
$app->post('/chat/poll', authorize('user'), 'pollChat');
