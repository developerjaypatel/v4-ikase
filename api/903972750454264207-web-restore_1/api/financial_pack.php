...
$app->get('/financial', authorize('user'),	'getFinancials');
//$app->get('/financial/:case_id', authorize('user'),	'getFinancial');
$app->get('/financial/:case_id', authorize('user'),	'getFullFinancial');
$app->get('/financialtotals/:case_id', authorize('user'),	'getFinancialTotals');
$app->get('/financialcarrier/:case_id/:corporation_id', authorize('user'),	'getCarrierFinancial');

$app->post('/financialcarrier/add', authorize('user'), 'addCarrierFinancial');
$app->post('/financial/add', authorize('user'), 'addFullFinancial');
//$app->post('/personal_injury/update', authorize('user'), 'updateFinancial');
