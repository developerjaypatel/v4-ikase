<?php
$app->get('/homemedical/:id', authorize('user'),	'getHomeMedical');
$app->get('/homemedicals/:case_id', authorize('user'),	'getHomeMedicals');

//posts
$app->post('/homemedical/delete', authorize('user'), 'deleteHomeMedical');
$app->post('/homemedical/add', authorize('user'), 'addHomeMedical');
$app->post('/homemedical/update', authorize('user'), 'updateHomeMedical');
