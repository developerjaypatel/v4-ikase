...
try {
	...
	*/
	foreach($cases as $key=>$case){
		...
		$sql = "
		INSERT INTO `" . $data_source . "`.`" . $data_source . "_task` (`task_uuid`, `task_name`, `task_description`, `task_dateandtime`, `completed_date`, `assignee`, `task_priority`, `task_type`,`customer_id`, `deleted`)
		SELECT 
