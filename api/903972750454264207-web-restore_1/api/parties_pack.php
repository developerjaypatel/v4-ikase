<?php
$app->get('/parties/:id', authorize('user'), 'getKaseParties');
$app->get('/offices/:id', authorize('user'), 'getKaseOffices');
$app->get('/partielist/:id/:type', authorize('user'), 'getKasePartiesByType');
$app->get('/rolodex', authorize('user'), 'getRolodex');
$app->get('/rolodex/search/:search_term', authorize('user'), 'searchRolodex');
$app->get('/dashboard/:id/:title', authorize('user'), 	'getKaseParties');
//$app->get('/parties/:id', authorize('user'), 	'getPartie');
$app->get('/parties/type/', authorize('user'), 	'typePartie');

//posts
$app->post('/bing/search', authorize('user'), 'getBingLocation');
$app->post('/rolodex/relate', authorize('user'), 'relateRolodex');
//$app->post('/parties/add', authorize('user'), 'addForm');
//$app->post('/parties/update', authorize('user'), 'updateForm');
