...
//		die($somecontent );
	...
	*/
	...
	$filename = "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\envelopes\\" . $form_name . "_plain.fdf";
	$pdftk_output =  "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\envelopes\\" . $form_name . "_" . $corporation_id . ".pdf";
	$file_counter = 1;
...
function generatePDF($form_name = "", $separator_title = "") {
	...
	$pdftk_output =  "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\\eams_forms\\" . $form_file_name . ".pdf";
	$file_counter = 1;
	$output_store_name = $form_file_name . ".pdf";
	while (file_exists($pdftk_output)) {
		$pdftk_output =  "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\\eams_forms\\" . $form_file_name . "_" . $file_counter . ".pdf";
	...
	$filename = "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\\eams_forms\\" . $form_file_name . ".fdf";
	$source_dir = $_SERVER['DOCUMENT_ROOT'] . '\\eams_forms\\';
	...
	if ($form_name!="app_cover" && !$blnInternalRequest) {
		//create thumbnail
		$upload_dir = "D:\\uploads\\" . $_SESSION['user_customer_id'];
	...
	if ($form_name=="app_cover") {
		...
		*/
		...
		$arrFiles = array("D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\\eams_forms\\" . $output_store_name);
		$separator_path = "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\\eams_forms\\";
		$separator_find = "D:/uploads/" . $_SESSION["user_customer_id"] . "/" . $case_id . "/eams_forms/";
		
		$doc_path = "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\\jetfiler\\";
		$doc_path_2 = "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\\";
		...
		foreach($documents as $doc_index=>$doc) {
			...
			//"D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\
		}
		//die(print_r($arrFiles));
		//put together the pdftk string
		$filename_output = "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\jetfiler\\app_cover.pdf";
		
		$file_counter = 1;
		$output_store_name = $form_name . "_final.pdf";
		$pdftk_output =  "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\\eams_forms\\" . $output_store_name;
		...
		*/
		...
		while (file_exists($pdftk_output)) {
			$pdftk_output =  "D:\\uploads\\" . $_SESSION['user_customer_id'] . "\\" . $case_id . "\\eams_forms\\" . $form_name . "_" . $file_counter . "_final.pdf";
