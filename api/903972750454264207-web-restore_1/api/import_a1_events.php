	...
	*/
	...
	foreach($cases as $key=>$case){
		...
		*/
		...
		$sql = "
		INSERT INTO `" . $data_source . "`.`" . $data_source . "_event` (`event_uuid`, `event_title`, `event_name`, `event_duration`, `event_description`, `event_dateandtime`, `full_address`, `judge`, `assignee`, 
