...
$filename = ROOT_PATH . "\\chats\\-1\\cf_data.html";
...
$filename = UPLOADS_PATH . $customer_id . DC . $case_id . "\\eams_forms\\" . $form_name . ".fdf";
$pdftk_output =  UPLOADS_PATH . $customer_id . DC . $case_id . "\\eams_forms\\" . $original_filename;
