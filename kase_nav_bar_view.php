    ...
    <ul class="nav navbar-nav">
        ...
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Kases <b class="caret"></b></a>
            <ul class="dropdown-menu" style="width:100%">
                ...
                <li class="divider"></li>
                <% } %>
				<li class="kases-list-menu" style="text-align:left; display:"><a href="#recentkases" style="width:100%">Recent Kases</a></li>  
                
                <?php if ($customer_id != 1195) { ?>
					<li class="kases-list-menu" style="text-align:left; display:"><a id="active_kases" style="width:100%; cursor:pointer">Active Kases</a></li>
                <?php } ?>
       ...
       <li class="kases-list-menu" style="text-align:left;">
        ...
        <li class="kases-new-menu dropdown">
            ...
            <!--checkrequest_indicator pointer-events: none;-->
        ...
        <li class="kases-new-menu dropdown">
            ...
            <div id="orphan_unassigned_indicator" style="cursor:pointer; position:absolute; z-index:1039; left:0px; top:32px; font-size:0.75em; background:yellow; color:red; border:1px solid red; height:16px; width:18px; text-align:center; vertical-align:bottom; display:none; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; margin-bottom:10px" title="Click to review inattended uploaded Unassigned documents"></div>
      		<div id="unassigned_assigned_indicator" style="cursor:pointer; position:absolute; z-index:1039; left:0px; top:32px; font-size:0.75em; background:rgb(0, 102, 255); color:white; border:1px solid white; height:16px; width:18px; text-align:center; vertical-align:bottom; display:<?php if ($blnAdmin) { ?>none<?php } else { ?>none<?php } ?>; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; margin-bottom:10px" title="Click to review documents assigned to you">1</div>      
            ...
            <div id="new_my_document" class="new_my_document" style="cursor:pointer; position:absolute; z-index:1039; left:<?php echo $indicator_left; ?>px; top:5px; font-size:0.75em; background:white; color:black; border:1px solid white; height:16px; width:18px; text-align:center; vertical-align:bottom; display:none; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; margin-bottom:10px" title="Click to review recently uploaded Scans"></div>
            ...
            <div class="notifications_indicator" id="notifications_indicator" style="cursor:pointer; position:absolute; z-index:1039; left:<?php echo $indicator_left; ?>px; top:32px; font-size:0.75em; background:white; color:black; border:1px solid white; height:16px; width:18px; text-align:center; vertical-align:bottom; display:none; -moz-border-radius: 3px; -webkit-border-radius: 3px; -khtml-border-radius: 3px; border-radius: 3px; margin-bottom:10px" title="Click to review documents assigned to you"></div>
            ...
            <ul class="dropdown-menu" style="width:190px">
                <li class="kases-list-menu" style="text-align:left; width:100%; display:">
        ...
        <?php } ?>
        <?php //if ($_SESSION["user_customer_id"]!="1121") { ?>
        <li style="margin-top:15px; padding-right:5px; border-left:1px solid white; margin-left:15px">&nbsp;</li>
        <li class="tasks">
        	<div style="margin-top:10px">
                ...
                <a title="Click to enter Chat" id="list_chat" style="cursor:pointer; font-size:1.5em; color:#F3C; text-decoration:none"><i class="icon-comment">&nbsp;</i></a>
        		</div>
                <%
        	...
        	<a title="Click to start Chat" id="new_chat" style="cursor:pointer; font-size:1.5em; color:#F9F; text-decoration:none"><i class="icon-comment-1">&nbsp;</i></a>
            	</div>
                
            </div>
        </li>
		<?php //} ?>
        <li style="margin-top:15px; <?php if ($_SESSION["user_customer_id"]=="1121") { ?>margin-left:15px; <?php } ?>padding-right:5px; border-left:1px solid white">&nbsp;</li>
        <?php } ?>
        <li class="phone">
        	<div style="margin-top:15px">
